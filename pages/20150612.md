---
blog_url: https://blog.acolyer.org/2015/06/12/naiad-a-timely-dataflow-system/
blog_title: Naiad: A Timely Dataflow&nbsp;System
---
...
## Post navigation
 ...
 &lsaquo; PreviousThe Drinking Philosophers ProblemNext &rsaquo;Twitter Heron: Stream Processing at Scale
...
## 
 17 thoughts on &ldquo;Naiad: A Timely Dataflow System&rdquo; 
...
- 
 ...
 Pingback: Four short links: 12 June 2015 - O'Reilly Radar 
 
 
- 
 
 Pingback: Links & Reads from 2015 Week 24 | Martin&#039;s Weekly Curations 
 
 
- 
 
 Pingback: Differential Dataflow | the morning paper 
...
- 
 ...
 Pingback: TensorFlow: A system for large-scale machine learning | CS TOPIC 
 
 
- 
 
 Pingback: Metadata and the Naiad post - one other good blog on Data Science/Engineering | The Information Age 
...
- 
 ...
 Pingback: Noria: dynamic, partially-stateful data-flow for high-performance web applications | the morning paper 
 
 
- 
 
 Pingback: Noria: dynamic, partially-stateful data-flow for high-performance web applications | Theresa Welchy 
 
 
- 
 
 Pingback: 1 – An interesting/influential/important paper from the world of CS every morning | Traffic.Ventures Social 
 
 
- 
 
 Pingback: Noria: dynamic, partially-stateful data-flow for high-performance web applications | Daily AI 
