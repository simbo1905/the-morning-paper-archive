---
blog_url: https://blog.acolyer.org/2019/04/08/how-bad-can-it-git-characterizing-secret-leakage-in-public-github-repositories/
blog_title: How bad can it git? Characterizing secret leakage in public GitHub&nbsp;repositories
---
...
## Post navigation
 ...
 &lsaquo; PreviousGinseng: keeping secrets in registers when you distrust the operating systemNext &rsaquo;Don’t trust the locals: investigating the prevalence of persistent client-side cross-site scripting in the wild
...
## 
 19 thoughts on &ldquo;How bad can it git? Characterizing secret leakage in public GitHub repositories&rdquo; 
...
The biggest takeaway for me is that Google maintains a BigQuery dataset of public GitHub repos...
...
- 
 ...
 Pingback: New top story on Hacker News: How bad can it Git? Characterizing secret leakage in public GitHub repositories - Latest news 
 
 
- 
 
 Pingback: New top story on Hacker News: How bad can it Git? Characterizing secret leakage in public GitHub repositories - News about world 
 
 
- 
 
 Pingback: New top story on Hacker News: How bad can it Git? Characterizing secret leakage in public GitHub repositories - Outside The Know 
 
 
- 
 
 Pingback: New top story on Hacker News: How bad can it Git? Characterizing secret leakage in public GitHub repositories - Hckr News 
 
 
- 
 
 Pingback: New top story on Hacker News: How bad can it Git? Characterizing secret leakage in public GitHub repositories - Golden News 
 
 
- 
 
 Pingback: New top story on Hacker News: How bad can it Git? Characterizing secret leakage in public GitHub repositories - World Best News 
 
 
- 
 
 Pingback: How bad can it Git? Characterizing secret leakage in public GitHub repositories | My Tech Blog 
 
 
- 
 
 Pingback: Characterizing secret leakage in public GitHub repositories | My Tech Blog 
 
 
- 
 
 Pingback: How bad can it git? Characterizing secret leakage in public GitHub repositories - JNW 
 
 
- 
 
 Pingback: How bad can it git? Characterizing secret leakage in public GitHub repositories - TARIAN LIMITED 
 
 
- 
 
 Pingback: Some great links for 04/09/2019 - Pito Salas&#039; Blog 
 
 
- 
 
 Pingback: Hexbyte News Computers How bad can it git? Characterizing secret leakage in public GitHub repositories - HexByte Inc. 
...
You should totally turn this project into a permanently running bot which automatically creates an issue whenever a secret key (or more) is pushed to the repository, together with the relevant steps to undo the damage (like revoking, regenerating and update of the .gitignore)

Kind of a good gesture for all developers. :)
...
- 
 ...
 Pingback: How bad can it git? Characterizing secret leakage in public GitHub repositories – the morning paper - The Library 5.0 
 
 
- 
 
 Pingback: Secure Projects With One Piece of Code - UrIoTNews 
 
 
- 
 
 Pingback: Are Passwords for Web Authentication Obsolete? Leakage of Passwords and API-Keys and Possible Solutions | Computer Science Blog 
 
 
- 
 
 Pingback: Are Passwords for Web Authentication Obsolete? Leakage of Passwords and API-Keys and Possible Solutions - BLOG.MI 
