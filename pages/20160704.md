---
blog_url: https://blog.acolyer.org/2016/07/04/natural-language-understanding-almost-from-scratch/
blog_title: Natural language understanding (almost) from&nbsp;scratch
---
...
## Post navigation
 ...
 &lsaquo; PreviousBuilding end-to-end dialogue systems using generative hierarchical neural network modelsNext &rsaquo;End-to-end learning of semantic role labeling using recurrent neural networks
...
## 
 4 thoughts on &ldquo;Natural language understanding (almost) from scratch&rdquo; 
...
- 
 ...
 Pingback: End-to-end learning of semantic role labeling using recurrent neural networks | the morning paper 
 
 
- 
 
 Pingback: End-to-end learning of semantic role labeling using recurrent neural networks | 神刀安全网 
 
 
- 
 
 Pingback: Four short links: 5 July 2016 | A bunch of data 
