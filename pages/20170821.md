---
blog_url: https://blog.acolyer.org/2017/08/21/paracloud-bringing-application-insight-into-cloud-operations/
blog_title: Paracloud: bringing application insight into cloud&nbsp;operations
---
...
> 
 ...
 Such scenarios can be handled better by tying Paracloud with cloud load balancers... we propose to expose an appYield interface between containers and the cloud platform, enabling applications to yield themselves temporarily during high resource contention, similar to Linux' sched_yield-based co-operative scheduling.
...
## Post navigation
 ...
 &lsaquo; PreviousDeep photo style transferNext &rsaquo;JavaScript for extending low-latency in-memory key-value stores
...
## 
 4 thoughts on &ldquo;Paracloud: bringing application insight into cloud operations&rdquo; 
...
- 
 ...
 Pingback: Four short links: 21 August 2017 | Vedalgo 
 
 
- 
 
 Pingback: 4 small inbound links: 21 August 2017 &#124; IBM Spectrum Storage Solutions 
 
 
- 
 
 Pingback: Four short links: 21 August 2017 | A bunch of data 
 
 
- 
 
 Pingback: The Morning Paper: Keeping up with Computer Science Research - The Data Racket 
