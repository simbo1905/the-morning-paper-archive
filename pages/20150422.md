---
blog_url: https://blog.acolyer.org/2015/04/22/distributed-snapshots-determining-global-states-of-distributed-systems/
blog_title: Distributed Snapshots: Determining Global States of Distributed&nbsp;Systems
---
...
## Post navigation
 ...
 &lsaquo; PreviousDeclarative Interaction Design for Data VisualizationNext &rsaquo;From the Aether to the Ethernet - Attacking the Internet using Broadcast Digital Television
...
## 
 14 thoughts on &ldquo;Distributed Snapshots: Determining Global States of Distributed Systems&rdquo; 
...
- 
 ...
 Pingback: Links & Reads from 2015 Week 17 | Martin&#039;s Weekly Curations 
...
How to generate these the hand-drawing pictures ??
...
I hand draw them, and then just scan my drawing :). I need something quick and simple given that I put out a post every weekday...
...
- 
 ...
 Pingback: High-throughput, low-latency, and exactly-once stream processing with Apache Flink | data Artisans 
...
- 
 ...
 Pingback: Ownership and Reference Counting Based Garbage Collection in the Actor World | the morning paper 
...
Collecting all of the local state snapshots to from the global picture is left as an exercise for the reader.

from maybe is form. a typo?
...
Yes, it should say 'form' ! Thanks, Adrian.
...
- 
 ...
 Pingback: Chain Services with Exactly-Once Guarantees | Confluent 
 
 
- 
 
 Pingback: Some research on Flink - StreamBench 
 
 
- 
 
 Pingback: Flink初探-为什么选择Flink - ITPCB 
