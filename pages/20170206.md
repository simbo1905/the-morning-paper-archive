---
blog_url: https://blog.acolyer.org/2017/02/06/password-managers-attacks-and-defenses/
blog_title: Password managers: attacks and&nbsp;defenses
---
...
- When a login form is autofilled by a password manager, it becomes unreadable by JavaScript (hence the requirement for a modified browser).

- If username or password fields are modified (by the user or JavaScript) while an autofill is in progress, the autofill aborts clearing the password from the password field and making the field readable agin.

- Once a form with autofill is submitted and after all JavaScript code that is going to be run has run, the browser checks the form's action matches the stored one and only submits if so.
...
## Post navigation
 ...
 &lsaquo; PreviousDynamics on emerging spaces: modeling the emergence of noveltiesNext &rsaquo;Finding security bugs in web applications using a catalog of access control patterns
...
## 
 17 thoughts on &ldquo;Password managers: attacks and defenses&rdquo; 
...
- 
 ...
 Pingback: Password managers: attacks and defenses - sec.uno 
...
- 
 ...
 Pingback: 【知识】2月7日 - 每日安全知识热点 - 莹莹之色 
...
As a long-standing 1Password user, thank you! 
...
- 
 ...
 Pingback: IT Security Weekend Catch Up – February 13, 2017 - BadCyber 
 
 
- 
 
 Pingback: 密码管理器的攻防博弈 - 涉密行业新闻网 
 
 
- 
 
 Pingback: 密码管理器的攻防博弈 - 莹莹之色 
 
 
- 
 
 Pingback: 密码管理器的攻防博弈 - Terry & CoCo 
...
- 
 ...
 Pingback: My Reading List 2017 | Bigta 
 
 
- 
 
 Pingback: Weekendowa Lektura 2017-02-13 - lepiej późno niż wcale | Zaufana Trzecia Strona 
