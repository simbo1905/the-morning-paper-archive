---
blog_url: https://blog.acolyer.org/2016/11/24/smart-reply-automated-response-suggestion-for-email/
blog_title: Smart Reply: Automated response suggestion for&nbsp;email
---
...
## Post navigation
 ...
 &lsaquo; PreviousPlaying FPS games with deep reinforcement learningNext &rsaquo;Building machines that learn and think like people
...
## 
 5 thoughts on &ldquo;Smart Reply: Automated response suggestion for email&rdquo; 
...
- 
 ...
 Pingback: Four short links: 24 November 2016 | A bunch of data 
 
 
- 
 
 Pingback: Weekly Links List: Machine learning introduction; Research papers from Google and Microsoft; Learning from the past - visionaries in computing - Querydog - Weekly Links List and Research Log 
...
- 
 ...
 Pingback: Four short links: 24 November 2016 | Vedalgo 
