---
blog_url: https://blog.acolyer.org/2018/02/05/quantum-computing-in-the-nisq-era-and-beyond/
blog_title: Quantum computing in the NISQ era and&nbsp;beyond
---
...
- We know of problems believed to be hard for classical computers, but for which quantum algorithms have been discovered which can solve these problems easily. The best known example is Shor’s algorithm for prime factorisation. 
...
- No known classical algorithm can simulate a quantum computer, even after many decades of trying. 
...
## Post navigation
 ...
 &lsaquo; PreviousPolynomial-time algorithms for prime factorization and discrete logarithms on a quantum computerNext &rsaquo;Quantum algorithms: an overview
...
## 
 5 thoughts on &ldquo;Quantum computing in the NISQ era and beyond&rdquo; 
...
- 
 ...
 Pingback: New top story on Hacker News: Quantum computing in the NISQ era and beyond - Tech + Hckr News 
 
 
- 
 
 Pingback: Quantum computing in the NISQ era and beyond - posted at February 05, 2018 at 09:21AM by bello - Startup News 2018 
 
 
- 
 
 Pingback: New top story on Hacker News: Quantum computing in the NISQ era and beyond - ÇlusterAssets Inc., 
