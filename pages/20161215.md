---
blog_url: https://blog.acolyer.org/2016/12/15/fasst-fast-scalable-and-simple-distributed-transactions-with-two-sided-rdma-datagram-rpcs/
blog_title: FaSST: Fast, scalable and simple distributed transactions with two-sided (RDMA) datagram&nbsp;RPCs
---
...
## Related
 ...
 NetworkingTransaction processing 
...
## Post navigation
 ...
 &lsaquo; PreviousSCONE: Secure Linux containers with Intel SGXNext &rsaquo;TensorFlow: A system for large-scale machine learning
...
## 
 6 thoughts on &ldquo;FaSST: Fast, scalable and simple distributed transactions with two-sided (RDMA) datagram RPCs&rdquo; 
