---
blog_url: https://blog.acolyer.org/2017/03/08/redundancy-does-not-imply-fault-tolerance-analysis-of-distributed-storage-reactions-to-single-errors-and-corruptions/
blog_title: Redundancy does not imply fault tolerance: analysis of distributed storage reactions to single errors and&nbsp;corruptions
---
...
## Post navigation
 ...
 &lsaquo; PreviousThou shalt not depend on me: analysing the use of outdated JavaScript libraries on the webNext &rsaquo;MaMaDroid: Detecting Android malware by building Markov chains of behavorial models
...
## 
 10 thoughts on &ldquo;Redundancy does not imply fault tolerance: analysis of distributed storage reactions to single errors and corruptions&rdquo; 
...
- 
 ...
 Pingback: Worth Reading: Redundancy does not imply fault tolerance - &#039;net work 
 
 
- 
 
 Pingback: SRE Weekly Issue #66 - SRE WEEKLY 
...
- 
 ...
 Pingback: Fail-slow at scale: evidence of hardware performance faults in large production systems | the morning paper 
