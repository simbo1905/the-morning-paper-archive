---
blog_url: https://blog.acolyer.org/2017/10/23/why-neurons-have-thousands-of-synapses-a-theory-of-sequence-memory-in-neocortex/
blog_title: Why neurons have thousands of synapses, a theory of sequence memory in&nbsp;neocortex
---
...
## Post navigation
 ...
 &lsaquo; PreviousComputing machinery and intelligenceNext &rsaquo;Continuous online sequence learning with an unsupervised neural network model
...
## 
 5 thoughts on &ldquo;Why neurons have thousands of synapses, a theory of sequence memory in neocortex&rdquo; 
...
My problem with the HTM is that although they claim to take inspiration from biology, their method of learning isn't biologically plausible at all. See this discussion on my lab's forum:

https://forum.nengo.ai/t/hierarchical-temporal-memory-vs-nef-spa/257

It's fine not being biologically plausible if that's not a priority. I just very personally feel like they keep emphasising that in their writing, which feels somewhat disengenous?
...
@seanny123 that link was dead for me
...
The forum went down sometime this morning. It's back up now.
...
- 
 ...
 Pingback: Why neurons have thousands of synapses, a theory of sequence memory in neocortex | ExtendTree 
 
 
- 
 
 Pingback: Continuous online sequence learning with an unsupervised neural network model | the morning paper 
