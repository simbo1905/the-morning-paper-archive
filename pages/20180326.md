---
blog_url: https://blog.acolyer.org/2018/03/26/information-flow-reveals-prediction-limits-in-online-social-activity/
blog_title: Information flow reveals prediction limits in online social&nbsp;activity
---
...
> 
 ...
 The ability to accurately profile and predict individuals is reflected in the predictability of their written text. The predictive information contained within a user’s text can be characterized by three quantities: the entropy rate, , the perplexity , and the predictability, .
...
Perplexity is just another way of expressing the same thing. It tells us that the remaining uncertainty about unseen words is equivalent to choosing uniformly at random from words. In this study, is typically around 6 bits, so the perplexity is 64 words - much less than the approximately 5000 word vocabulary social media users have on average).

The predictability, , is the probability that an ideal prediction algorithm will correctly predict the subsequent word given the preceding text.
...
## Post navigation
 ...
 &lsaquo; PreviousTracking ransomware end-to-endNext &rsaquo;Anna: A KVS for any scale
...
## 
 4 thoughts on &ldquo;Information flow reveals prediction limits in online social activity&rdquo; 
...
- 
 ...
 Pingback: New top story on Hacker News: Information flow reveals prediction limits in online social activity - Tech + Hckr News 
 
 
- 
 
 Pingback: New top story on Hacker News: Information flow reveals prediction limits in online social activity 
 
 
- 
 
 Pingback: New top story on Hacker News: Information flow reveals prediction limits in online social activity - ÇlusterAssets Inc., 
