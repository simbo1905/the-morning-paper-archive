---
blog_url: https://blog.acolyer.org/2018/03/15/exposing-congestion-attack-on-emerging-connected-vehicle-based-traffic-signal-control/
blog_title: Exposing congestion attack on emerging connected vehicle based traffic signal&nbsp;control
---
...
## Post navigation
 ...
 &lsaquo; PreviousGame of missuggestions: semantic analysis of search autocomplete manipulationNext &rsaquo;When coding style survives compilation: de-anonymizing programmers from executable binaries
...
## 
 5 thoughts on &ldquo;Exposing congestion attack on emerging connected vehicle based traffic signal control&rdquo; 
...
- 
 ...
 Pingback: Four short links: 15 March 2018 | Vedalgo 
 
 
- 
 
 Pingback: Four short links: 15 March 2018 - DUI Lawyer 
 
 
- 
 
 Pingback: Four short links: 15 March 2018 - Home Improvement Designs 
...
Since the BSM includes identity, why not keep a list of those and filter out identities seen in the last few minutes. So the identity can say it is lane 1 at just the wrong timing, but cannot say the same 20 seconds later (not enough time to go around the block). Extend this so that the third time in 60 seconds filters it out for 10 minutes etc. This filter is like the delays used to deter brute force password cracking.
...
- 
 ...
 Pingback: 4 shorter backlinks: 15 March 2018 - IBM Spectrum Storage Solutions 
