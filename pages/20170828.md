---
blog_url: https://blog.acolyer.org/2017/08/28/using-chatbots-against-voicespam-analyzing-lennys-effectiveness/
blog_title: Using chatbots against voicespam: analyzing Lenny&#8217;s&nbsp;effectiveness
---
...
## Post navigation
 ...
 &lsaquo; PreviousTowards deploying decommissioned mobile devices as cheap energy-efficient compute nodesNext &rsaquo;Seeing is believing: a client-centric specification of database isolation
...
## 
 26 thoughts on &ldquo;Using chatbots against voicespam: analyzing Lenny's effectiveness&rdquo; 
...
- 
 ...
 Pingback: Four short links: 28 August 2017 | Vedalgo 
 
 
- 
 
 Pingback: 4 short back links: 28 August 2017 &#124; IBM Spectrum Storage Solutions 
 
 
- 
 
 Pingback: Four short links: 28 August 2017 | A bunch of data 
 
 
- 
 
 Pingback: New top story on Hacker News: Using chatbots against voicespam: analyzing Lenny’s effectiveness - The Internet Yard 
 
 
- 
 
 Pingback: Using chatbots against voicespam: analyzing Lenny’s effectiveness | ExtendTree 
 
 
- 
 
 Pingback: The use of chatbots against voicespam: analyzing Lenny&#039;s effectiveness | A1A 
 
 
- 
 
 Pingback: Clive Thompson 
 
 
- 
 
 Pingback: Send scam emails to this chatbot and it’ll waste their time for you | Global Networks 
 
 
- 
 
 Pingback: Send scam emails to this chatbot and it’ll waste their time for you - TechPreachers.com 
 
 
- 
 
 Pingback: Trick5 - Send scam emails to this chatbot and it’ll waste their time for you - Trick5 | Trick5 Simplify The Technology 
 
 
- 
 
 Pingback: Send scam emails to this chatbot and it’ll waste their time for you - Kopitiam Bot 
 
 
- 
 
 Pingback: Send scam emails to this chatbot and it’ll waste their time for you - techietricks.com 
 
 
- 
 
 Pingback: Send scam emails to this chatbot and it’ll waste their time for you - Techosmo 
 
 
- 
 
 Pingback: Send scam emails to this chatbot and it’ll waste their time for you - Technology News, latest technology information, all about technology 
 
 
- 
 
 Pingback: Send scam emails to this chatbot and it&#039;ll waste their time for you 
 
 
- 
 
 Pingback: Este chatbot responderá todos tus correos electrónicos fraudulentos 
 
 
- 
 
 Pingback: Send rip-off emails to this chatbot and it’ll raze their time for you | TMSS Magazine 
 
 
- 
 
 Pingback: Send scam emails to this chatbot and it’ll waste their time for you | University of South Wales: Information Security & Privacy 
 
 
- 
 
 Pingback: Send scam emails to this chatbot and it’ll waste their time for you - TheStarOne 
 
 
- 
 
 Pingback: Revue du web #2 : Geeks, Hacks sociaux, Bots, Trolling positif - Hacking social 
 
 
- 
 
 Pingback: A Month In Data, Part I - Data, Tech & Policy 
 
 
- 
 
 Pingback: K106.3 FM | Messing With Telemarketers: Meet "Lenny" 
 
 
- 
 
 Pingback: 第1089期AI100_机器学习日报(2017-09-11) - 机器研习会 
...
How can I get a chatbot for incoming scanner calls?

Sorry for hiding my real email
...
- 
 ...
 Pingback: Comment arnaquer les arnaqueurs sur Internet grâce à l&#039;intelligence artificielle | Beetzer 
...
Tonight I got a call on my small business phone line from someone using Lenny. Understand, to repeat: It was an incoming call to a small business (residence) FROM "Lenny" -- and yes, it was THE Lenny (old man w/near-British accent, seeming to wander in conversation, talking about his child who graduated college... the *exact* script and voice of Lenny). I do not and have never made automated calls out, and am not a telemarketer, etc. I only use the phone to call directly to speak in person to family, friends, and KNOWN associates (in other words, in the 20+ years the number has been mine, my phone has never been used to make 'unwelcome' calls to anyone). After the call, I mentioned the call to family, one of whom is highly conversive with AI and computer science subjects, who recognized it might be Lenny, and he found the script information and audio for me to confirm. WHY would anyone use Lenny to call homes or businesses (and waste business time resources, which is offensive), rather than as a tool to respond to *incoming* scammer phone calls? The only reasons I can suppose -- the caller is using it purposefully to harass, or Lenny is being used to gather response data (or audio), possibly for development of scammer scripts (https://www.npr.org/2019/11/18/779386167/the-language-of-cybercrime).
