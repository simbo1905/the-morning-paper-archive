---
blog_url: https://blog.acolyer.org/2017/08/25/towards-deploying-decommissioned-mobile-devices-as-cheap-energy-efficient-compute-nodes/
blog_title: Towards deploying decommissioned mobile devices as cheap energy-efficient compute&nbsp;nodes
---
...
A TCO analysis shows that the mobile array beats the traditional server on TCO by some margin. (In the figures below 'A' is the traditional server, 'B' is the mobile array, and &delta; is the depreciation rate).
...
## Post navigation
 ...
 &lsaquo; PreviousA cloud-based content gathering networkNext &rsaquo;Using chatbots against voicespam: analyzing Lenny's effectiveness
...
## 
 9 thoughts on &ldquo;Towards deploying decommissioned mobile devices as cheap energy-efficient compute nodes&rdquo; 
...
- 
 ...
 Pingback: Four short links: 25 August 2017 | Vedalgo 
...
- 
 ...
 Pingback: Four short links: 25 August 2017 | A bunch of data 
