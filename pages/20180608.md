---
blog_url: https://blog.acolyer.org/2018/06/08/bds-a-centralized-near-optimal-overlay-network-for-inter-datacenter-data-replication/
blog_title: BDS: A centralized near-optimal overlay network for inter-datacenter data&nbsp;replication
---
...
## Post navigation
 ...
 &lsaquo; PreviousDynamic control flow in large-scale machine learningNext &rsaquo;Improving the expressiveness of deep learning frameworks with recursion
...
## 
 One thought on &ldquo;BDS: A centralized near-optimal overlay network for inter-datacenter data replication&rdquo; 
