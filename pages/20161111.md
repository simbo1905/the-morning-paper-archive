---
blog_url: https://blog.acolyer.org/2016/11/11/error-handling-of-in-vehicle-networks-makes-them-vulnerable/
blog_title: Error handling of in-vehicle networks makes them&nbsp;vulnerable
---
...
- It has the same ID as message M

- It is transmitted at the same time as message M

- It has at least one bit position in which it is dominant (a zero), whereas it is recessive in M (a one). All the preceding bits should be the same as the message M.
...
## Post navigation
 ...
 &lsaquo; PreviousWhen CSI meets public wifi: Inferring your mobile phone password via wifi signalsNext &rsaquo;Acing the IOC game: toward automatic discovery and analysis of open-source cyber threat intelligence
...
## 
 3 thoughts on &ldquo;Error handling of in-vehicle networks makes them vulnerable&rdquo; 
...
- 
 ...
 Pingback: The Network Standard Used in Cars Is Wide Open to Attack - Pinnacle of reliability 
 
 
- 
 
 Pingback: The Network Standard Used in Cars Is Wide Open to Attack - Arthur Keleti 
 
 
- 
 
 Pingback: Wireless attacks on aircraft instrument landing systems - the morning paper 
