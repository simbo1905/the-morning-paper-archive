---
blog_url: https://blog.acolyer.org/2019/05/17/understanding-real-world-concurrency-bugs-in-go/
blog_title: Understanding real-world concurrency bugs in&nbsp;Go
---
...
## Post navigation
 ...
 &lsaquo; PreviousSeer: leveraging big data to navigate the complexity of performance debugging in cloud microservicesNext &rsaquo;RPCValet: NI-driven tail-aware balancing of &micro;s-scale RPCs
...
## 
 25 thoughts on &ldquo;Understanding real-world concurrency bugs in Go&rdquo; 
...
How about create a sequence of posts about concurrency bugs, and in the next ones you can present just one bug and explain in detail how it was detected, impact, fix, etc. Will be interesting see one example of each category.
...
- 
 ...
 Pingback: Understanding real-world concurrency bugs in Go - Golang News 
...
I'm not sure I agree with the conclusion... Kubernetes code base is 2.3M loc, show me a similar project ( highly concurent app ) in a different language with less concurrency bugs.
...
- 
 ...
 Pingback: New top story on Hacker News: Understanding real-world concurrency bugs in Go - Hckr News 
 
 
- 
 
 Pingback: New top story on Hacker News: Understanding real-world concurrency bugs in Go - Golden News 
 
 
- 
 
 Pingback: New top story on Hacker News: Understanding real-world concurrency bugs in Go - News about world 
 
 
- 
 
 Pingback: New top story on Hacker News: Understanding real-world concurrency bugs in Go - Latest news 
 
 
- 
 
 Pingback: New top story on Hacker News: Understanding real-world concurrency bugs in Go - World Best News 
 
 
- 
 
 Pingback: New top story on Hacker News: Understanding real-world concurrency bugs in Go - Outside The Know 
 
 
- 
 
 Pingback: Understanding real-world concurrency bugs in Go - INDIA NEWS 
 
 
- 
 
 Pingback: Understanding real-world concurrency bugs in Go | Mark Beazley | MarkBeazley.Com 
 
 
- 
 
 Pingback: Understanding real-world concurrency bugs in Go | My Tech Blog 
 
 
- 
 
 Pingback: Understanding real-world concurrency bugs in Go - Hacker News Robot 
...
Interesting qualitative study but somewhat flawed conclusions. Correlation does not imply causation. Causation requires controlled experiments.

E.g. "more blocking bugs in our studied Go applications are caused by wrong message passing than by wrong shared memory protection" => ok interesting.

But it does not generalize to "message passing does not necessarily make multi-threaded programs less error-prone than shared memory" because that requires a comparing the number of bugs of the SAME program written in ONLY message-passing VS ONLY shared memory paradigm.
...
should be: "Go programs have fewer concurrency bugs".
...
do not police people's grammar on line, thank's
...
- 
 ...
 Pingback: GoCN每日新闻(2019-05-18) - SUNXIAOHE 
 
 
- 
 
 Pingback: eloraiby/fs-pacer - Newbyo 
 
 
- 
 
 Pingback: eloraiby/fs-pacer 
 
 
- 
 
 Pingback: eloraiby/fs-pacer - I Love Blockchain 
 
 
- 
 
 Pingback: От ключа не убежишь -- Episode 0243 &laquo; DevZen Podcast 
...
The 'time' package was not mentioned until the conclusion: can you elaborate on *how* misuse of the time library causes problems?
...
- 
 ...
 Pingback: [Перевод] Топ-10 самых распространенных ошибок, которые мне встречались в Go-проектах - CHEPA website 
 
 
- 
 
 Pingback: [Перевод] Топ-10 самых распространенных ошибок, которые мне встречались в Go-проектах -- MAILSGUN.RU 
