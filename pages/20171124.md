---
blog_url: https://blog.acolyer.org/2017/11/24/on-the-information-bottleneck-theory-of-deep-learning/
blog_title: On the information bottleneck theory of deep&nbsp;learning
---
...
The authors used code supplied by Schwartz-Vis and Tishby to first replicate the results that we saw last week (Fig 1A below), and then changed the network to use ReLU instead — rectified linear activation functions . The resulting information plane dynamics are show in Fig 1B.
...
Using a very simple three neuron network, the authors explore this phenomenon further. A scalar Gaussian input distribution is fed through a scalar first layer weight and passed through a neural nonlinearity to yield hidden unit activity .
...
## Post navigation
 ...
 &lsaquo; PreviousKV-Direct: High-performance in-memory key-value store with programmable NICNext &rsaquo;SVE: Distributed video processing at Facebook scale
...
## 
 6 thoughts on &ldquo;On the information bottleneck theory of deep learning&rdquo; 
