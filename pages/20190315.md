---
blog_url: https://blog.acolyer.org/2019/03/15/exploiting-commutativity-for-practical-fast-replication/
blog_title: Exploiting commutativity for practical fast&nbsp;replication
---
...
## Post navigation
 ...
 &lsaquo; PreviousCloud computing simplified: a Berkeley view on serverless computingNext &rsaquo;Datacenter RPCs can be general and fast
...
## 
 8 thoughts on &ldquo;Exploiting commutativity for practical fast replication&rdquo; 
...
- 
 ...
 Pingback: Datacenter RPCs can be general and fast | the morning paper 
 
 
- 
 
 Pingback: Datacenter RPCs can be general and fast - GG&#039;s Place 
 
 
- 
 
 Pingback: Calvin: fast distributed transactions for partitioned database systems | the morning paper 
