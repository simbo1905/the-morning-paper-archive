---
blog_url: https://blog.acolyer.org/2016/06/15/ix-a-protected-dataplane-operating-system-for-high-throughput-and-low-latency/
blog_title: IX: A protected dataplane operating system for high throughput and low&nbsp;latency
---
...
Finally the team test two memcached workloads and report averaged and 99th percentile latency at different throughputs. The Linux baseline setup was carefully tuned so that 99th percentile latency did not exceed 200-500&micro;s following established practices. The ETC workload represents the highest capacity deployment in Facebook, and the USR workload is the deployment with the most GET requests (99%).
...
## Post navigation
 ...
 &lsaquo; PreviousArrakis: the operating system is the control planeNext &rsaquo;Shielding applications from an untrusted cloud with Haven
...
## 
 8 thoughts on &ldquo;IX: A protected dataplane operating system for high throughput and low latency&rdquo; 
