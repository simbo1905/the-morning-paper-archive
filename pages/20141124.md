...
## Related
 ...
 AmazonDistributed SystemsFormal methods 
...
## Post navigation
 ...
 &lsaquo; PreviousChurch's Thesis and Functional ProgrammingNext &rsaquo;Detecting Discontinuities in Large-Scale Systems
...
## 
 18 thoughts on &ldquo;Use of Formal Methods at Amazon Web Services&rdquo; 
...
- 
 ...
 Pingback: Blazes: Coordination analysis for distributed programs | the morning paper 
 
 
- 
 
 Pingback: Online, Aysnchronous Schema Change in F1 | the morning paper 
...
- 
 ...
 Pingback: IronFleet: Proving Practical Distributed Systems Correct | the morning paper 
...
- 
 ...
 Pingback: Linux 基金会透露未来 Linux 内核可能会引入形式验证 | Linux Story 
 
 
- 
 
 Pingback: Linux 基金会透露未来 Linux 内核可能会引入形式验证 | News Pod 
 
 
- 
 
 Pingback: Linux 基金会透露未来 Linux 内核可能会引入形式验证 
...
- 
 ...
 Pingback: What, Why, and How of Formal Methods | Undrinkable Kool-Aid 
 
 
- 
 
 Pingback: Teaching rigorous distributed systems with efficient model checking | the morning paper 
 
 
- 
 
 Pingback: Teaching rigorous distributed systems with efficient model checking - Newbyo 
 
 
- 
 
 Pingback: Teaching rigorous distributed systems with efficient model checking - NewsUcan2Use 
