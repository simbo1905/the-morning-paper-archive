---
blog_url: https://blog.acolyer.org/2016/10/20/programming-with-abstract-data-types/
blog_title: Programming with Abstract Data&nbsp;Types
---
...
## Post navigation
 ...
 &lsaquo; PreviousProtection in programming languagesNext &rsaquo;A design methodology for reliable software systems
...
## 
 3 thoughts on &ldquo;Programming with Abstract Data Types&rdquo; 
...
I think it's worth pointing out that by the time this paper appeared the concept of object-oriented programming was already 7 years old. It debuted with the Simula 67 language, released in 1967. Simula 67 basically had everything the Java object system has, except exceptions, packages, and overloading. Classes, methods, inheritance, dynamic method override, etc. It was all there, and they knew how important it was. So while this is an important paper, it did not invent the concept of developing abstract data types with hidden implementation.
...
This paper really describes [CLU](https://en.wikipedia.org/wiki/CLU_(programming_language)), the language her group at MIT had been working on for several years. This language was just a bit too big for the computers of the day to compiler, so the world went to Pascal and then C and then OO languages.

Simula 67 is where OO started. But that had different problems: http://shape-of-code.coding-guidelines.com/2014/12/19/snobol-4-simula-67-smalltalk-sed-sql-setl-scratch-and-spreadsheet/
...
I wonder if by comparing that to OO, at least the class oriented OO we got, you are not hiding a bigger truth.

What is really interesting here is that Liskov describe only the "operations" you can make on the object. There is nothing implying the way data is represented. Especially you could have multiple objects with different data representation but the same ADT. It is closer to "ad hoc" polymorphism or full fledged generics than to classes.

>which is completely characterized by the operations available on those objects

It is interesting to see that this model mainly grew up in the FP world. And that is wherei would say it is close to Parnas' paper on hiding information about implementation vs interface. And i would argue that it is what is now giving an advantage to the FP world more than anything else.
