---
blog_url: https://blog.acolyer.org/2017/06/12/decoding-the-representation-of-code-in-the-brain-an-fmri-study-of-code-review-and-expertise/
blog_title: Decoding the representation of code in the brain: an fMRI study of code review and&nbsp;expertise
---
...
## Post navigation
 ...
 &lsaquo; PreviousNode.fz: fuzzing the server-side event-driven architectureNext &rsaquo;A dissection of the test-driven development process: does it really matter to test-first or test-last?
...
## 
 One thought on &ldquo;Decoding the representation of code in the brain: an fMRI study of code review and expertise&rdquo; 
...
- 
 ...
 Pingback: Papers we love: Begrip van code en taal. Gemeten met een fMRI scanner | Software Innovators 
