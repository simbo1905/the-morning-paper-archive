---
blog_url: https://blog.acolyer.org/2019/03/20/understanding-lifecycle-management-complexity-of-datacenter-topologies/
blog_title: Understanding lifecycle management complexity of datacenter&nbsp;topologies
---
...
- The number of switches. More switches equals more packaging complexity.

- The number of patch panels, which is a function of topological structure and a good proxy for wiring complexity.

- The number of bundle types. This metric captures the other important part of wiring complexity - how many distinct bundle types are needed. A bundle type is represented by its capacity (how how many fibres) and its length.
...
- The number of expansion steps, and

- The average number of rewired links in a patch panel rack.
...
## Post navigation
 ...
 &lsaquo; PreviousDatacenter RPCs can be general and fastNext &rsaquo;Slim: OS kernel support for a low-overhead container overlay network
...
## 
 One thought on &ldquo;Understanding lifecycle management complexity of datacenter topologies&rdquo; 
...
Great article! Management complexities are indeed expanding, owing to evolving organizations and their products and services. Server less is bringing business value back into the focus of software. Building vs. Optimizing, can lower business risk and help lower the break-even point.
