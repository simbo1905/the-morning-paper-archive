---
blog_url: https://blog.acolyer.org/2018/01/17/some-thoughts-on-security-after-ten-years-of-qmail-1-0/
blog_title: Some thoughts on security after ten years of qmail&nbsp;1.0
---
...
## Post navigation
 ...
 &lsaquo; PreviousSpectre attacks: exploiting speculative executionNext &rsaquo;RustBelt: securing the foundations of the Rust programming language
...
## 
 21 thoughts on &ldquo;Some thoughts on security after ten years of qmail 1.0&rdquo; 
...
- 
 ...
 Pingback: New top story on Hacker News: Some thoughts on security after ten years of Qmail 1.0 - ÇlusterAssets Inc., 
...
Please include an explanation of the acronym TCB (presumably 'trusted computing base'?). A simple reference on first mention of reducing the amount of trusted code would do.
...
"because he was fed us" -> "because he was fed up"
...
- 
 ...
 January 18, 2018 at 4:08 am 

 

 
 
I was using qmail back in 1999, so aren't we at ~20 years of it?
...
- 
 ...
 onewheelskyward says: 

 
 January 18, 2018 at 4:09 am 

 

 
 
I was using qmail back in 1999, so aren't we at more like ~20 years of it?
...
- 
 ...
 Pingback: RustBelt: securing the foundations of the Rust programming language | the morning paper 
 
 
- 
 
 Pingback: Some thoughts on security after ten years of #qmail 1.0 https://blo... | Dr. Roy Schestowitz (罗伊) 
...
You left out the most interesting quote in the light of Spectre:

"I am also assuming that the CPU does not leak secret

information from one process to another. This assumption

is debatable. Perhaps access to CPU instructions needs to

be limited, for example with the interpreter discussed in
...
Great article. Found a small typo in case you care ;) 

"fed us" should be "fed up" in first paragraph.
...
- 
 ...
 Pingback: Links for January 2018 - foreXiv 
...
- 
 ...
 Pingback: Google, Oracle, and Apple – Application Security Weekly #02 - Cyber Sercuirty 
 
 
- 
 
 Pingback: Some thoughts on security after ten years of qmail 1.0 - Eriks Links 
 
 
- 
 
 Pingback: The paradigms of programming | the morning paper 
 
 
- 
 
 Pingback: The paradigms of programming | Digitators 
 
 
- 
 
 Pingback: The paradigms of programming - Startupon.net 
 
 
- 
 
 Pingback: The paradigms of programming | A1A 
 
 
- 
 
 Pingback: The paradigms of programming | Softwares Bloggers | Softwares Reviews | Best Online Softwares 
...
"designing large portions of qmail to run in separate processes connected through pipelines made much of qmail’s internal data flow easier to see for example"

Is this an example of common sense, but not common practice? It is, after all, an very common concept in *nix based systems, but far from all. It's a pattern I've felt a little unsophisticated for employing (send text between processes? -- how droll) but have found the systems in which I did long-lasting and reliable.
...
- 
 ...
 Pingback: Security Resources - Random Ramblings 
