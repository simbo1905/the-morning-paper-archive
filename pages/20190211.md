---
blog_url: https://blog.acolyer.org/2019/02/11/exfakt-a-framework-for-explaining-facts-over-knowledge-graphs-and-text/
blog_title: ExFaKT: a framework for explaining facts over knowledge graphs and&nbsp;text
---
...
> 
 Knowledge Graphs (KGs) are large collections of factual triples of the form (SPO) about people, companies, places etc. 
...
## Post navigation
 ...
 &lsaquo; PreviousGraph neural networks: a review of methods and applicationsNext &rsaquo;Beyond news contents: the role of social context for fake news detection
...
## 
 6 thoughts on &ldquo;ExFaKT: a framework for explaining facts over knowledge graphs and text&rdquo; 
...
- 
 ...
 Pingback: Four short links: 11 February 2019 - MasMaz 
...
Reminds me of Prolog using Resolution to proof questions it is asked. E.g. described in http://web.cse.ohio-state.edu/~stiff.4/cse3521/prolog-resolution.html. However, Prolog deals with more variables than the at max three in SPOs.
...
- 
 ...
 Pingback: Four short links: 11 February 2019 - sportsguru 
 
 
- 
 
 Pingback: Four short links: 11 February 2019 - Dinezh.com 
...
I thought of prolog too! I'd be interested in seeing if this algorithm could be applied to a system which provides rich citation / attribution management support. Something like a combination citation-manager/knowledgebase. On the off chance anyone reads this and has any ideas, hmu
