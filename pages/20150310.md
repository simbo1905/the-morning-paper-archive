---
blog_url: https://blog.acolyer.org/2015/03/10/zookeepers-atomic-broadcast-protocol-theory-and-practice/
blog_title: ZooKeeper&#8217;s Atomic Broadcast Protocol: Theory and&nbsp;Practice
---
...
## Post navigation
 ...
 &lsaquo; PreviousZab: High-performance broadcast for primary-backup systemsNext &rsaquo;Vive La Différence: Paxos vs Viewstamped Replication vs Zab
...
## 
 2 thoughts on &ldquo;ZooKeeper's Atomic Broadcast Protocol: Theory and Practice&rdquo; 
...
You write "If the client is only a little bit out of date, a DIFF message will be sent with just the state the client is missing. If the client is ahead of the the leader though, a TRUNC message is sent."

It's not the client that is out of date. It's the *follower*.
