---
blog_url: https://blog.acolyer.org/2017/11/14/matrix-capsules-with-em-routing/
blog_title: Matrix capsules with EM&nbsp;routing
---
...
## Post navigation
 ...
 &lsaquo; PreviousDynamic routing between capsulesNext &rsaquo;Opening the black box of deep neural networks via information - part I
...
## 
 7 thoughts on &ldquo;Matrix capsules with EM routing&rdquo; 
...
- 
 ...
 Pingback: CapsuleNet - CapsNet - Capsule Network | BigSnarf blog 
...
- 
 ...
 Pingback: Machine learning systems are stuck in a rut - RAM NETWORK 
 
 
- 
 
 Pingback: Machine learning systems are stuck in a rut 
 
 
- 
 
 Pingback: Machine learning systems are stuck in a rut - Newbyo 
 
 
- 
 
 Pingback: Machine learning systems are stuck in a rut - NewsUcan2Use 
