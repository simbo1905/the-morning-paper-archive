---
blog_url: https://blog.acolyer.org/2019/02/04/tensorflow-js-machine-learning-for-the-web-and-beyond/
blog_title: TensorFlow.js: machine learning for the web and&nbsp;beyond
---
...
- Teachable machine - build your own image classifier in the browser using your webcam
- GAN lab - interactive visual exploration of GANs
- The ML5 online course for artists, creative coders, and students.
- Sign language to speech translation
- Many online demos shared through the community project gallery, including NeuroEvolution and a reinforcement learning environment for self-driving cars.
...
## Post navigation
 ...
 &lsaquo; PreviousFixed it for you: protocol repair using lineage graphsNext &rsaquo;A comprehensive survey on graph neural networks
...
## 
 6 thoughts on &ldquo;TensorFlow.js: machine learning for the web and beyond&rdquo; 
...
Good Quick Introduction to TensorFlow.JS
...
"Android shows lower due to a long tail of older devices with no GPU hardware)"
...
- 
 ...
 Pingback: TensorFlow.js: Machine Learning for the Web and Beyond | Linux.com | Top Tech Stories 
 
 
- 
 
 Pingback: #TensorFlow .js: machine learning for the web and beyond https://bl... | Dr. Roy Schestowitz (罗伊) 
 
 
- 
 
 Pingback: Data Science newsletter - February 8, 2019 | Sports.BradStenger.com 
