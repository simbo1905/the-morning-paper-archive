---
blog_url: https://blog.acolyer.org/2020/01/13/challenges-of-real-world-rl/
blog_title: Challenges of real-world reinforcement&nbsp;learning
---
...
- Effective off-line learning (e.g. from system logs)

- Fast learning on real systems given limited samples
...
- Reward functions that are un(der)specified, multi-objective, or risk-sensitive
...
> 
One very important component of deploying RL to any real product is interacting with the product owner or other human experts. We must work closely with the experts to formulate the right reward objectives and safety constraints, to get expert demonstrations to warm-start learning, and we must explain the algorithm's actions enough that they have enough confidence in the system to deploy it. These themes should point the way towards research that can address all these challenges and be deployed on more real world systems and products.
...
## Post navigation
 ...
 &lsaquo; PreviousTen challenges for making automation a 'team player' in joint human-agent activityNext &rsaquo;Programmatically interpretable reinforcement learning
...
## 
 15 thoughts on &ldquo;Challenges of real-world reinforcement learning&rdquo; 
...
- 
 ...
 Pingback: New top story on Hacker News: Challenges of real-world reinforcement learning – the morning paper - The Pakistani News Corner 
 
 
- 
 
 Pingback: New top story on Hacker News: Challenges of real-world reinforcement learning – the morning paper - News about world 
 
 
- 
 
 Pingback: Challenges of real-world reinforcement learning – the morning paper - INDIA NEWS 
 
 
- 
 
 Pingback: New top story on Hacker News: Challenges of real-world reinforcement learning – the morning paper - Latest news 
 
 
- 
 
 Pingback: Challenges of real-world reinforcement learning – the morning paper - Dhruba&#039;s Blog & Online News 
 
 
- 
 
 Pingback: New top story on Hacker News: Challenges of real-world reinforcement learning – the morning paper - Ultimate News 
 
 
- 
 
 Pingback: New top story on Hacker News: Challenges of real-world reinforcement learning – the morning paper - Hckr News 
 
 
- 
 
 Pingback: New top story on Hacker News: Challenges of real-world reinforcement learning – the morning paper - Outside The Know 
 
 
- 
 
 Pingback: New top story on Hacker News: Challenges of real-world reinforcement learning – the morning paper - protipsss 
 
 
- 
 
 Pingback: Top story HACKER NEWS: Challenges of real-world reinforcement learning – the morning paper - Nate&#039;s Blog 
...
- 
 ...
 Pingback: Challenges of real-world reinforcement learning – the morning paper - ideanesia 
...
- 
 ...
 Pingback: Enterprise Applications of Reinforcement Learning: Recommenders and Simulation Modeling - Anyscale 
