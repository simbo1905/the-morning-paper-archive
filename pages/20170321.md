---
blog_url: https://blog.acolyer.org/2017/03/21/convolution-neural-nets-part-2/
blog_title: Convolution neural nets, Part&nbsp;2
---
...
- Return of the devil in the details: delving deep into convolutional nets, Chatfield et al., 2014
...
## Post navigation
 ...
 &lsaquo; PreviousConvolutional neural networks, Part 1Next &rsaquo;Convolution neural networks, Part 3
...
## 
 6 thoughts on &ldquo;Convolution neural nets, Part 2&rdquo; 
...
- 
 ...
 Pingback: Understanding deep learning requires re-thinking generalization | the morning paper 
 
 
- 
 
 Pingback: Understanding deep learning requires re-thinking generalization | Artificia Intelligence 
 
 
- 
 
 Pingback: Photo-realistic single image super-resolution using a generative adversarial network | the morning paper 
 
 
- 
 
 Pingback: Blockchain: Links And Resources (274) | Angel "Java" Lopez on Blog 
