---
blog_url: https://blog.acolyer.org/2016/09/14/why-functional-programming-matters/
blog_title: Why Functional Programming&nbsp;Matters
---
...
Higher-order functions enable simple functions to be glued together to make more complex ones. I'm going to assume most readers are familiar with this idea. The example given in the paper is foldr, which captures a common computation pattern over lists, such that we can write for example:
...
## Post navigation
 ...
 &lsaquo; PreviousData on the Outside versus Data on the InsideNext &rsaquo;The Rise of Worse is Better
...
## 
 7 thoughts on &ldquo;Why Functional Programming Matters&rdquo; 
...
- 
 ...
 Pingback: Dew Drop - September 14, 2016 (#2328) - Morning Dew 
...
"... 23 pages, but the bulk of that is examples illustrating the author’s..." inability to come up with anything other than special cases to bolster lots of hand waving arguments.

Adrian, you always says nice things about the morning papers, even when they are complete drivel. I appreciate that a positive mindset is, well positive. But a more critical eye has its benefits.

Functional programming is a religion: http://shape-of-code.coding-guidelines.com/2015/10/15/lisp-and-functional-languages-discourage-free-riders/

As a language concept it is well past its sell by date: http://shape-of-code.coding-guidelines.com/2013/04/02/push-hard-on-a-problem-here-and-it-just-pop-up-over-there/
...
- 
 ...
 Pingback: The Rise of Worse is Better | the morning paper 
...
The lazy evaluation part needs to be explained with an example.
...
- 
 ...
 Pingback: Protection in programming languages | the morning paper 
...
http://a-functional-journey.com/blog/2017/02/09/why-functional.htm
