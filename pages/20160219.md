---
blog_url: https://blog.acolyer.org/2016/02/19/formal-requirements-for-virtualizable-third-generation-architectures/
blog_title: Formal Requirements for Virtualizable Third Generation&nbsp;Architectures
---
...
## Post navigation
 ...
 &lsaquo; PreviousOwnership and Reference Counting Based Garbage Collection in the Actor WorldNext &rsaquo;IncludeOS: A minimal, resource efficient unikernel for cloud systems
...
## 
 2 thoughts on &ldquo;Formal Requirements for Virtualizable Third Generation Architectures&rdquo; 
...
True Popek-Goldberg virtualization mandates that a virtual machine should be ~indistinguishable from a physical computer. While has proven to be a great transitional technology as we've transitioned from physical servers to virtual servers. Going forward I believe that we should let requirement #1 from Popek-Goldberg go.

Dragging a complete emulated server along a minimalistic virtual server isn't ideal. If we consider something like uKVM as a replacement for Qemu we end up with a significantly more secure and performant system. Case in point: VENOM attack which leveraged the virtual floppy drive in Qemu to break out of the VM.
...
I took my comment and my it into a blogpost. It is here: http://blog.includeos.org/2017/06/23/popek-goldberg-machines-considered-harmful
