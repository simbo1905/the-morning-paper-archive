---
blog_url: https://blog.acolyer.org/2016/03/14/secrets-lies-and-account-recovery-lessons-from-the-use-of-personal-knowledge-questions-at-google/
blog_title: Secrets, Lies, and Account Recovery: Lessons from the Use of Personal Knowledge Questions at&nbsp;Google
---
...
The study looks at vulnerability to online guessing attacks, where given that you have n guesses, &lambda;n represents the probability that you can guess the answer (ignoring any social engineering attacks etc.), and offline attacks where the attacker has gained access to the hashed answer database. Here the paper uses a metric G~&alpha; which captures the equivalent number of bits of information that would give the attacker an &alpha; probability of compromising a random user's account.
...
## Post navigation
 ...
 &lsaquo; PreviousStrategic Dialogue Management via Deep Reinforcement LearningNext &rsaquo;A Taxonomy of Attacks and a Survey of Defence Mechanisms for Semantic Social Engineering Attacks
...
## 
 3 thoughts on &ldquo;Secrets, Lies, and Account Recovery: Lessons from the Use of Personal Knowledge Questions at Google&rdquo; 
...
"And France, what’s going on with father’s middle names??" Easy: we don't have middle names.
...
- 
 ...
 Pingback: Four short links: 14 March 2016 - O'Reilly Radar 
