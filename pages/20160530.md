---
blog_url: https://blog.acolyer.org/2016/05/30/why-do-recordreplay-tests-of-web-applications-break/
blog_title: Why do record/replay tests of web applications&nbsp;break?
---
...
## Post navigation
 ...
 &lsaquo; PreviousA DNA-based archival storage systemNext &rsaquo;How to build static checking systems using orders of magnitude less code
...
## 
 7 thoughts on &ldquo;Why do record/replay tests of web applications break?&rdquo; 
...
Anybody know of any good strategies to address this problem? 
...
One response on twitter says:

'.@adriancolyer IIrc we had this locator issue on (Smart)GWT with Selenium and therefore switched to Sahi ( http://sahipro.com )' -- https://twitter.com/pilhuhn/status/737194430457909248

No idea if Sahi is any good or not, just passing on the response. (it sounds potentially interesting though.)
...
- 
 ...
 Pingback: Dew Drop - May 31, 2016 (#2262) | Morning Dew 
 
 
- 
 
 Pingback: Test Automation: why 'record and replay' fails - WatirMelon 
...
- 
 ...
 June 1, 2016 at 7:28 am 

 

 
 
Here is my take on how Sahi Pro can help you address those issues.
...
- 
 ...
 Pingback: "I am vengeance, I am the night, I am a Link" - Bruce Wayne - Magnus Udbjørg 
...
After long time i reading some worthful  Article about web master tools About, Web Development  thanks for sharing good information.
