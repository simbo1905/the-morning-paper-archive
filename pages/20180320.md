---
blog_url: https://blog.acolyer.org/2018/03/20/designing-secure-ethereum-smart-contracts-a-finite-state-machine-approach/
blog_title: Designing secure Ethereum smart contracts: a finite state machine&nbsp;approach
---
...
- Additional security plugins addressing more of the known vulnerability types for smart contracts, and plugins implementing the most popular design patterns surveyed in ‘An empirical analysis of smart contracts: platforms, applications, and design patterns.’ 

- Integration of verification tools and correctness-by-design techniques into the framework.

- Support of modelling and verifying multiple interacting contracts as a set of interaction finite state machines.
...
## Post navigation
 ...
 &lsaquo; PreviousA quantitive analysis of the impact of arbitrary blockchain content on BitcoinNext &rsaquo;On purpose and by necessity: compliance under the GDPR
...
## 
 2 thoughts on &ldquo;Designing secure Ethereum smart contracts: a finite state machine approach&rdquo; 
...
Can you post more about ICO and XYO networks of Crypto.This one is great.
...
Can you post more about ICO and XYO networks of Crypto.This one is great post..
