---
blog_url: https://blog.acolyer.org/2017/10/11/trustbase-an-architecture-to-repair-and-strengthen-certificate-based-authentication/
blog_title: TrustBase: an architecture to repair and strengthen certificate-based authentication
---
...
- Client applications frequently do not properly validate the server’s certificate

- TLS interception (used by many middleboxes) compromises the integrity of end-to-end encryption, “with many firewalls having significant implementation bugs that break authentication.”

- The CA system itself is vulnerable to being hijacked even when applications and proxies are implemented correctly.
...
## Post navigation
 ...
 &lsaquo; PreviousPretzel: email encryption and provider-supplied functions are compatibleNext &rsaquo;CHAINIAC: Proactive software update transparency via collectively signed skipchains and verified builds
...
## 
 One thought on &ldquo;TrustBase: an architecture to repair and strengthen certificate-based authentication&rdquo; 
...
- 
 ...
 Pingback: TrustBase: an architecture to repair and strengthen certificate-based authentication | EDUMIO.com 
