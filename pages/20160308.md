---
blog_url: https://blog.acolyer.org/2016/03/08/cryptonets-applying-neural-networks-to-encrypted-data-with-high-throughput-and-accuracy/
blog_title: CryptoNets: Applying Neural Networks to Encrypted Data with High Throughput and&nbsp;Accuracy
---
...
## Post navigation
 ...
 &lsaquo; PreviousTrajectory Data Mining: An OverviewNext &rsaquo;Neural Turing Machines
...
## 
 8 thoughts on &ldquo;CryptoNets: Applying Neural Networks to Encrypted Data with High Throughput and Accuracy&rdquo; 
...
- 
 ...
 Pingback: Four short links: 8 March 2016 - O'Reilly Radar 
...
Recently started following your blog: very interesting selection of papers so far!

In this particular paper, one limitation I see (that they also mention) is that the training phase is done on unencrypted data, leaving a privacy issue both for bootstrapping the model but also for adapting it as new data comes in. The same assumption is made in the second paper you mention.

To this end, the cited paper by Aslett et al. is interesting in that they actually do both training and prediction on encrypted data (plus they have a neat trick for division on encrypted data, which is notoriously difficult in secure computation) but pay a somewhat high price in terms of computing.

At any rate, this is very interesting work and it shows that real-world applications of homomorphic encryption is getting closer and closer!
...
Is homohorphic encryption a kind of homomorphic encryption?
...
Homohorphic encryption is just me consistently misspelling homomorphic! My fingers must have been having a bad day that day! 
...
- 
 ...
 Pingback: Rebar3, Docker и Гомоморфное шифрование -- Episode 0083 &laquo; DevZen Podcast 
...
- 
 ...
 Pingback: CryptoNets: Applying Neural Networks to Encrypted Data with High Throughput and Accuracy | the morning paper | Big Data Cloud 
