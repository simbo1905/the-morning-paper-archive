---
blog_url: https://blog.acolyer.org/2017/10/03/tfx-a-tensorflow-based-production-scale-machine-learning-platform/
blog_title: TFX: A TensorFlow-based production scale machine learning&nbsp;platform
---
...
## Post navigation
 ...
 &lsaquo; PreviousGoogle Vizier: A service for black-box optimizationNext &rsaquo;ActiveClean: Interactive data cleaning for statistical modeling
...
## 
 6 thoughts on &ldquo;TFX: A TensorFlow-based production scale machine learning platform&rdquo; 
...
- 
 ...
 Pingback: Four shorter backlinks: 3 Oct 2017 &#124; IBM Spectrum Storage Solutions 
 
 
- 
 
 Pingback: Four short links: 3 October 2017 | A bunch of data 
...
- 
 ...
 Pingback: ActiveClean: Interactive data cleaning for statistical modeling | the morning paper 
 
 
- 
 
 Pingback: 论文导读 | TFX：基于TensorFlow可大规模扩展的机器学习平台 2017-10-29 - Androidev 
