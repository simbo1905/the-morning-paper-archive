---
blog_url: https://blog.acolyer.org/2017/01/27/cardinality-estimation-done-right-index-based-join-sampling/
blog_title: Cardinality estimation done right: index-based join&nbsp;sampling
---
...
## Related
 ...
 Posted in Datastores, Uncategorized 
...
## Post navigation
 ...
 &lsaquo; PreviousThe truth, the whole truth, and nothing but the truth: a pragmatic guide to assessing empirical evaluationsNext &rsaquo;How good are query optimizers, really?
...
## 
 2 thoughts on &ldquo;Cardinality estimation done right: index-based join sampling&rdquo; 
...
- 
 ...
 Pingback: How good are query optimizers, really? | the morning paper 
 
 
- 
 
 Pingback: The Self-Tuning Database? | The SQL Herald 
