---
blog_url: https://blog.acolyer.org/2018/10/19/orca-differential-bug-localization-in-large-scale-services/
blog_title: Orca: differential bug localization in large-scale&nbsp;services
---
...
## Post navigation
 ...
 &lsaquo; PreviousREPT: reverse debugging of failures in deployed softwareNext &rsaquo;LegoOS: a disseminated, distributed OS for hardware resource disaggregation
...
## 
 8 thoughts on &ldquo;Orca: differential bug localization in large-scale services&rdquo; 
...
- 
 ...
 Pingback: New top story on Hacker News: Orca: differential bug localization in large-scale services - World Best News 
 
 
- 
 
 Pingback: New top story on Hacker News: Orca: differential bug localization in large-scale services - Golden News 
 
 
- 
 
 Pingback: New top story on Hacker News: Orca: differential bug localization in large-scale services - Latest news 
 
 
- 
 
 Pingback: New top story on Hacker News: Orca: differential bug localization in large-scale services - News about world 
 
 
- 
 
 Pingback: New top story on Hacker News: Orca: differential bug localization in large-scale services - Hckr News 
 
 
- 
 
 Pingback: Maelstrom: mitigating datacenter-level disasters by draining interdependent traffic safely and efficiently | the morning paper 
 
 
- 
 
 Pingback: Maelstrom: mitigating datacenter-level disasters by draining interdependent traffic safely and efficiently | Theresa Welchy 
 
 
- 
 
 Pingback: Maelstrom: mitigating datacenter-level disasters by draining interdependent traffic safely and efficiently | Daily AI 
