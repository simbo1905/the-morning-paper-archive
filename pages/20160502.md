---
blog_url: https://blog.acolyer.org/2016/05/02/slacker-fast-distribution-with-lazy-docker-containers/
blog_title: Slacker: Fast Distribution with Lazy Docker&nbsp;Containers
---
...
> 
 ...
 ... instead of representing every layer as an NFS file, Slacker (when possible) represents them with a piece of local metadata that records a snapshot ID. ApplyDiff simply sets this metadata instead of immediately cloning. If at some point Docker calls Get on that layer, Slacker will at that point perform a real clone before the mount.
...
## Post navigation
 ...
 &lsaquo; PreviousOptimizing Distributed Actor Systems for Dynamic Interactive ServicesNext &rsaquo;Gorilla: A fast, scalable, in-memory time series database
...
## 
 2 thoughts on &ldquo;Slacker: Fast Distribution with Lazy Docker Containers&rdquo; 
