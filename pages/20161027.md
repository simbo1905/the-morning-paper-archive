---
blog_url: https://blog.acolyer.org/2016/10/27/replex-a-scalable-highly-available-multi-index-data-store/
blog_title: Replex: A scalable, highly available multi-index data&nbsp;store
---
...
## Post navigation
 ...
 &lsaquo; PreviousPreemptive intrusion detection: theoretical framework and real-world measurementsNext &rsaquo;A Bayesian approach to graphical record linkage and de-duplication
...
## 
 2 thoughts on &ldquo;Replex: A scalable, highly available multi-index data store&rdquo; 
...
- 
 ...
 Pingback: CouchDB Weekly News, October 27, 2016 - CouchDB Blog 
 
 
- 
 
 Pingback: vCorfu: A cloud-scale object store on a shared log | the morning paper 
