---
blog_url: https://blog.acolyer.org/2015/09/21/particle-swarm-optimization/
blog_title: Particle Swarm Optimization
---
...
## Post navigation
 ...
 &lsaquo; PreviousBuffer Overflows: Attacks and Defenses for the Vulnerability of the DecadeNext &rsaquo;Ant Algorithms for Discrete Optimization
...
## 
 9 thoughts on &ldquo;Particle Swarm Optimization&rdquo; 
...
- 
 ...
 Pingback: Firefly Algorithms for Multimodal Optimization | the morning paper 
 
 
- 
 
 Pingback: A New Metaheuristic Bat-Inspired Algorithm | the morning paper 
...
- 
 ...
 Pingback: Symmetry Reduction Enables Model Checking of More Complex Emerging Behaviours of Swarm Navigation Algorithms | the morning paper 
...
Hi! Thank you for this post! I have been researching about PSO for some time now, and from what I'm getting, for some reason, it seems as though it is not widely adopted- at least surprisingly, not in sorting out biological datasets (the case of microarray data for example, the last pso based paper dates back to 2011)... I began to question if the original technique or its variations are some sort of a dying art compared with deep learning techniques, and was hoping to find such an answer in your blog... Would you please shed some light on these?
...
I'm not close enough to the practitioner community here to give you a well-informed answer sadly. But hopefully another reader of this post may be able to enlighten us...
...
I am currently building a Python-based PSO library that can be used as a research toolkit. Right now I just implemented the standard global-best and local-best PSO (and still in development stage). 

I stumbled upon your blog and I am interested to hear what other people who do PSO think of this project. Also, would you mind giving suggestions on what other PSO variants & problems that can be implemented in the toolkit? 

Here's the link https://github.com/ljvmiranda921/pyswarms
...
- 
 ...
 Pingback: The new dynamics of strategy: sense-making in a complex and complicated world | the morning paper 
