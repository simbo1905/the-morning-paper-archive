---
blog_url: https://blog.acolyer.org/2019/09/02/ipa/
blog_title: IPA: invariant-preserving applications for weakly consistent replicated&nbsp;databases
---
...
## Post navigation
 ...
 &lsaquo; PreviousChoosing a cloud DBMS: architectures and tradeoffsNext &rsaquo;SLOG: serializable, low-latency, geo-replicated transactions
...
## 
 2 thoughts on &ldquo;IPA: invariant-preserving applications for weakly consistent replicated databases&rdquo; 
...
I am working on a system with similar challenges to those described in this paper, and also a similar pattern is implemented to "solve" this.

However, if a system reaches sufficient complexity, keeping track of new invariant's introduced becomes highly challenging, and the initially mentioned data corruption occurs. This can become a bigger issue that implementing patterns to guarantee that particular invariants are never violated.
