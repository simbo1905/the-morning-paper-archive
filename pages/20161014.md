---
blog_url: https://blog.acolyer.org/2016/10/14/program-development-by-stepwise-refinement/
blog_title: Program development by stepwise&nbsp;refinement
---
...
## Post navigation
 ...
 &lsaquo; PreviousGo to statement considered harmfulNext &rsaquo;Information distribution aspects of design methodology
...
## 
 5 thoughts on &ldquo;Program development by stepwise refinement&rdquo; 
...
Very nice paper and write-up, that presents a valuable tactic. So many times, I encounter people who just want to jump in, and start writing code to solve a problem, when a good white board session will do a lot to help clarify the direction to take. It's also enormously helpful to solve a problem before solving a problem!
...
- 
 ...
 Pingback: Programming with Abstract Data Types | the morning paper 
 
 
- 
 
 Pingback: Program development by stepwise refinement - Wrong problem 
