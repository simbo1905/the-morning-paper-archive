---
blog_url: https://blog.acolyer.org/2015/12/08/a-survey-on-reactive-programming/
blog_title: A Survey on Reactive&nbsp;Programming
---
...
- The supported basic abstractions
...
## Post navigation
 ...
 &lsaquo; PreviousFunctional Reactive AnimationNext &rsaquo;Asynchronous Functional Reactive Programming for GUIs
...
## 
 6 thoughts on &ldquo;A Survey on Reactive Programming&rdquo; 
...
The inline link in text, Fran, is pointing to this blog post.
...
- 
 ...
 Pingback: Links & Reads from 2015 Week 50 - Martin&#039;s Weekly Curations 
...
- 
 ...
 July 1, 2018 at 10:19 am 

 

 
 
Where are the mathematicians and Category Theorists when you need them!? Surely, if distribution is an algebra including CRDTs as a subset, and 'reactive' is algebra over streams, and DAG dataflow is a partial order, and multidirectional flows are cyclic graphs, then they can all be merged into a single algebra with many useful results for push/pull local/distributed glitchy/smooth cyclic/DAGgy flat/lifted systems.
