---
blog_url: https://blog.acolyer.org/2014/12/08/on-the-duality-of-operating-system-structures/
blog_title: On the duality of operating system&nbsp;structures
---
...
- The two models are duals of each other. That is, a program or subsystem constructed
...
The dual programs or subsystems are logically identical to each other. They can also be made textually very similar, differing only in non-essential details.

- 

The performance of a program or subsystem from one model, as reflected by its queue
...
## Post navigation
 ...
 &lsaquo; PreviousTachyon: Reliable, Memory Speed Storage for Cluster ComputingNext &rsaquo;Why threads are a bad idea
...
## 
 9 thoughts on &ldquo;On the duality of operating system structures&rdquo; 
...
- 
 ...
 Pingback: Why threads are a bad idea | the morning paper 
...
- 
 ...
 Pingback: Scala Actors: Unifying thread-based and event-based programming | the morning paper 
...
- 
 ...
 Pingback: Desert Island Papers: Peter Alvaro | the morning paper 
...
- 
 ...
 Pingback: Debugging data flows in reactive programs | the morning paper 
