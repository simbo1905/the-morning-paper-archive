---
blog_url: https://blog.acolyer.org/2016/03/09/neural-turing-machines/
blog_title: Neural Turing Machines
---
...
The combined addressing solution works as follows. Firstly the content-addressing weightings are calculated. Then these weightings are blended with those from the previous time-step according to an interpolation gate scalar g &isin; (0,1) emitted by each head to produce the gated weighting.
...
## Post navigation
 ...
 &lsaquo; PreviousCryptoNets: Applying Neural Networks to Encrypted Data with High Throughput and AccuracyNext &rsaquo;Memory Networks
...
## 
 15 thoughts on &ldquo;Neural Turing Machines&rdquo; 
...
- 
 ...
 Pingback: Memory Networks | the morning paper 
 
 
- 
 
 Pingback: Strategic Dialogue Management via Deep Reinforcement Learning | the morning paper 
...
- 
 ...
 Pingback: RNN models for image generation | the morning paper 
...
- 
 ...
 Dennis A. Mertens says: 

 
 March 27, 2019 at 7:29 am 
