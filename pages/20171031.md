---
blog_url: https://blog.acolyer.org/2017/10/31/same-stats-different-graphs-generating-datasets-with-varied-appearance-and-identical-statistics-through-simulated-annealing/
blog_title: Same stats, different graphs: generating datasets with varied appearance and identical statistics through simulated&nbsp;annealing
---
...
## Post navigation
 ...
 &lsaquo; PreviousOccupy the cloud: distributed computing for the 99%Next &rsaquo;DeepXplore: automated whitebox testing of deep learning systems
...
## 
 5 thoughts on &ldquo;Same stats, different graphs: generating datasets with varied appearance and identical statistics through simulated annealing&rdquo; 
...
- 
 ...
 Pingback: Can you trust the trend? Discovering Simpson’s paradoxes in social data | the morning paper 
 
 
- 
 
 Pingback: Challenging common assumptions in the unsupervised learning of disentangled representations - the morning paper 
 
 
- 
 
 Pingback: Same Stats, Different Graphs (2017) - Viral Cruncher 
 
 
- 
 
 Pingback: Data visualisation ideas and libraries for bioinformatics | Sequencing QC and data analysis blog 
