---
blog_url: https://blog.acolyer.org/2019/01/21/design-continuums-and-the-path-toward-self-designing-key-value-stores-that-know-and-learn/
blog_title: Design continuums and the path toward self-designing key-value stores that know and&nbsp;learn
---
...
## Related
 ...
 Algorithms and data structuresDatastores 
...
## Post navigation
 ...
 &lsaquo; PreviousTowards a hands-free query optimizer through deep learningNext &rsaquo;The data calculator: data structure design and cost synthesis from first principles and learned cost models
...
## 
 3 thoughts on &ldquo;Design continuums and the path toward self-designing key-value stores that know and learn&rdquo; 
...
- 
 ...
 Pingback: Design continuums and the path toward self-designing key-value stores that know and learn | the morning paper - Nodejs 
 
 
- 
 
 Pingback: Daily Bookmarks to GAVNet 01/22/2019 | Greener Acres Value Network News 
