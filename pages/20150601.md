---
blog_url: https://blog.acolyer.org/2015/06/01/graphx-graph-processing-in-a-distributed-dataflow-framework/
blog_title: GraphX: Graph Processing in a Distributed Dataflow&nbsp;Framework
---
...
SELECT source.Id, dest.Id, source.Props, edge.Props, dest.Props
FROM edges as edge
JOIN vertices AS source JOIN vertices AS dest
ON edge.srcId = source.Id AND edge.destId = dest.Id 
...
## Post navigation
 ...
 &lsaquo; PreviousPowerGraph: Distributed Graph-Parallel Computation on Natural GraphsNext &rsaquo;FlashGraph: Processing Billion Node Graphs on an Array of Commodity SSDs
...
## 
 4 thoughts on &ldquo;GraphX: Graph Processing in a Distributed Dataflow Framework&rdquo; 
...
- 
 ...
 Pingback: Scalability! But at what COST? | the morning paper 
