---
blog_url: https://blog.acolyer.org/2015/08/13/streams-a-la-carte-extensible-pipelines-with-object-algebras/
blog_title: Streams à la carte: Extensible pipelines with object&nbsp;algebras
---
...
- There is no way to alter the semantics of a streaming pipeline without changing the library itself - e.g. push-vs-pull operators, adding logging, performing async computation and so on.

- It is not possible (easy?) to add new operators due to the way that evaluation is performed:
...
## Post navigation
 ...
 &lsaquo; PreviousGlobal Sequence ProtocolNext &rsaquo;PerfBlower: Quickly Detecting Memory-Related Performance Problems via Amplification
...
## 
 5 thoughts on &ldquo;Streams à la carte: Extensible pipelines with object algebras&rdquo; 
...
- 
 ...
 Pingback: Streams à la carte: Extensible pipelines with object algebras | JAVA 
 
 
- 
 
 Pingback: Scrap Your Boilerplate with Object Algebras | the morning paper 
