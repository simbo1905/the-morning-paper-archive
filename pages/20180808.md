---
blog_url: https://blog.acolyer.org/2018/08/08/hhvm-jit-a-profile-guided-region-based-compiler-for-php-and-hack/
blog_title: HHVM JIT: A profile-guided, region-based compiler for PHP and&nbsp;Hack
---
...
## Post navigation
 ...
 &lsaquo; PreviousBLeak: automatically debugging memory leaks in web applicationsNext &rsaquo;Bounding data races in space and time - part I
...
## 
 6 thoughts on &ldquo;HHVM JIT: A profile-guided, region-based compiler for PHP and Hack&rdquo; 
...
- 
 ...
 Pingback: New top story on Hacker News: HHVM JIT: A profile-guided, region-based compiler for PHP and Hack - News about world 
 
 
- 
 
 Pingback: New top story on Hacker News: HHVM JIT: A profile-guided, region-based compiler for PHP and Hack - Tech + Hckr News 
 
 
- 
 
 Pingback: New top story on Hacker News: HHVM JIT: A profile-guided, region-based compiler for PHP and Hack - Latest news 
 
 
- 
 
 Pingback: New top story on Hacker News: HHVM JIT: A profile-guided, region-based compiler for PHP and Hack - World Best News 
