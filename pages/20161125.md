---
blog_url: https://blog.acolyer.org/2016/11/25/building-machines-that-learn-and-think-like-people/
blog_title: Building machines that learn and think like&nbsp;people
---
...
## Post navigation
 ...
 &lsaquo; PreviousSmart Reply: Automated response suggestion for emailNext &rsaquo;Kraken: Leveraging live traffic tests to identify and resolve resource utilization bottlenecks in large scale web services
...
## 
 16 thoughts on &ldquo;Building machines that learn and think like people&rdquo; 
...
I still maintain that "Towards deep symbolic reinforcement learning" is just a simpler implementation of Spaun. Additionally, when you talk about the "character problem" you're actually talking about One Shot Learning. Finally, adapting to new goals rapidly given only reinforcement-learning feedback, this is the hallmark of Model-based Reinforcement Learning. 

Hopefully these terms will guide you through further readings on the topic.
...
Thanks for the pointers. Spaun definitely sounds interesting, I'll look that up.
...
Let me know if you have any questions about the paper. Sorry for the late reply, I apparently didn't have my email settings configured properly.
...
- 
 ...
 Pingback: Four short links: 25 November 2016 | A bunch of data 
...
- 
 ...
 Pingback: Good review of AI research and where it might lead - Sherlock Codes 
 
 
- 
 
 Pingback: Four short links: 25 November 2016 | Vedalgo 
 
 
- 
 
 Pingback: Welcome to 2017 | the morning paper 
...
- 
 ...
 Pingback: AI: Pattern Recognition & Model-Building | Delightful & Distinctive COLRS 
...
It reinforces what Chomsky has been saying for a long time about the difference between much of AI and what he calls human "discovery" of solutions, the methods of which remain mysterious. His analogy is that pattern matching is like doing physics by pointing a camera out of a window and slowly making predictions over time, which it might do well, but with zero explanatory power. The irony is that much of ML is considered to be about generating "insights" whereas it is the human that does that bit.
...
Reblogged this on Papier de soi and commented:

https://adnumerique.blog
