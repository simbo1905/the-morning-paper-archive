---
blog_url: https://blog.acolyer.org/2015/10/14/coz-finding-code-that-counts-with-causal-profling/
blog_title: Coz: Finding code that counts with causal&nbsp;profiling
---
...
The point is nicely illustrated by the following simple program, which starts two threads in parallel and waits for them both to finish.
 ...
 void a() { // takes ~6.7 seconds
 for (volatile size_t x=0; x<2000000000; x++) {} 
 }
 
 void b() { // takes ~6.4 seconds
 for (volatile size_t x=0; x<1900000000; x++) {} 
 } 
...
## Post navigation
 ...
 &lsaquo; PreviousPivot Tracing: Dynamic Causal Monitoring for Distributed SystemsNext &rsaquo;IronFleet: Proving Practical Distributed Systems Correct
...
## 
 One thought on &ldquo;Coz: Finding code that counts with causal profiling&rdquo; 
...
Reblogged this on Emery Blogger and commented:
