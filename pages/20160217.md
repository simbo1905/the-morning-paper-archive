---
blog_url: https://blog.acolyer.org/2016/02/17/deny-capabilities/
blog_title: Deny Capabilities for Safe, Fast&nbsp;Actors
---
...
## Post navigation
 ...
 &lsaquo; PreviousCapability Myths DemolishedNext &rsaquo;Ownership and Reference Counting Based Garbage Collection in the Actor World
...
## 
 11 thoughts on &ldquo;Deny Capabilities for Safe, Fast Actors&rdquo; 
...
Nice numbers there, seem quite interesting.
...
Great article! Can we get the codebase used for the benchmark?
...
I don't see it in their GitHub source tree, but I can ask the authors for you...
...
Thanks! It's always helpful to analyze and tinker the code on your own :)
...
I get a 404 Error when trying to access the Clebsh et all paper
...
Maybe this link direct to their GitHub paper repo will work better for you - you can find today's paper there as well: https://github.com/ponylang/ponylang.github.io/tree/master/papers
...
- 
 ...
 July 11, 2016 at 3:10 am 

 

 
 
The link to the paper in your document for me is "https://github.com/ponylang/ponylang.github.io/blob/master/papers/fast-cheap.pdf~~" - notice the 2 trailing tildes.

If I remove those 2 trailing tildes then the link wfm.

Inspecting the html for me shows them within the href.
