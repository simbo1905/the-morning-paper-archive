---
blog_url: https://blog.acolyer.org/2019/08/19/robust-learning-from-untrusted-sources/
blog_title: Robust learning from untrusted&nbsp;sources
---
...
> 
 ...
 Intuitively, the discrepancy between the two distributions is large, if there exists a predictor that performs well on one of them and badly on the other. On the other hand, if all functions in the hypothesis class perform similarly on both, then and have low discrepancy.
...
- We have different datasets to combine
- is the weight assigned to the ith dataset
- is the discrepancy score between dataset and the reference dataset .
...
The second term is a kind of regularisation parameter. is the number of data points in the ith dataset, so it’s designed to encourage more confidence to be placed in the result of classifiers trained over larger datasets.
...
## Post navigation
 ...
 &lsaquo; PreviousEnd of termNext &rsaquo;Statistical foundations of virtual democracy
...
## 
 15 thoughts on &ldquo;Robust learning from untrusted sources&rdquo; 
...
- 
 ...
 Pingback: New top story on Hacker News: Robust Learning from Untrusted Sources - News about world 
 
 
- 
 
 Pingback: New top story on Hacker News: Robust Learning from Untrusted Sources - World Best News 
 
 
- 
 
 Pingback: New top story on Hacker News: Robust Learning from Untrusted Sources - Hckr News 
 
 
- 
 
 Pingback: New top story on Hacker News: Robust Learning from Untrusted Sources - Latest news 
 
 
- 
 
 Pingback: Robust Learning from Untrusted Sources | Mark Beazley | MarkBeazley.Com 
 
 
- 
 
 Pingback: Robust Learning from Untrusted Sources - INDIA NEWS 
 
 
- 
 
 Pingback: New top story on Hacker News: Robust Learning from Untrusted Sources - protipsss 
...
- 
 ...
 Pingback: New top story on Hacker News: Robust Learning from Untrusted Sources - Outside The Know 
 
 
- 
 
 Pingback: New top story on Hacker News: Robust Learning from Untrusted Sources - Golden News 
 
 
- 
 
 Pingback: Four short links: 20 August 2019 | Technology News and Markets 
 
 
- 
 
 Pingback: Four short links: 20 August 2019 - sportsguru 
 
 
- 
 
 Pingback: Four short links: 20 August 2019 -- KeepMany.Com Web Portal And News Site 
 
 
- 
 
 Pingback: Linkdump #119 | WZB Data Science Blog 
 
 
- 
 
 Pingback: Tech roundup 37: a journal published by a bot - Javi López G. 
