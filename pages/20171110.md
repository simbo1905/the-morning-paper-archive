---
blog_url: https://blog.acolyer.org/2017/11/10/a-model-for-reasoning-about-javascript-promises/
blog_title: A model for reasoning about JavaScript&nbsp;promises
---
...
- given is an address in the heap, that is not currently mapped to promise values, and an expression promisify(a)
...
## Post navigation
 ...
 &lsaquo; PreviousType test scripts for TypeScript testingNext &rsaquo;Dynamic routing between capsules
...
## 
 One thought on &ldquo;A model for reasoning about JavaScript promises&rdquo; 
...
- 
 ...
 Pingback: A model for reasoning about JavaScript promises - Full-Stack Feed 
