---
blog_url: https://blog.acolyer.org/2018/03/12/synode-understanding-and-automatically-preventing-injection-attacks-on-node-js/
blog_title: Synode: understanding and automatically preventing injection attacks on&nbsp;Node.js
---
...
## Post navigation
 ...
 &lsaquo; PreviousSettling payments fast and private: efficient decentralized routing for path-based transactionsNext &rsaquo;JavaScript Zero: real JavaScript, and zero side-channel attacks
...
## 
 6 thoughts on &ldquo;Synode: understanding and automatically preventing injection attacks on Node.js&rdquo; 
...
- 
 ...
 Pingback: New top story on Hacker News: 20% of all Node.js modules found vunerable to injection attacks - Tech + Hckr News 
 
 
- 
 
 Pingback: New top story on Hacker News: 20% of all Node.js modules found vunerable to injection attacks - ÇlusterAssets Inc., 
 
 
- 
 
 Pingback: Synode: understanding and automatically preventing injection attacks on Node.js | the morning paper 
 
 
- 
 
 Pingback: New top story on Hacker News: Synode: understanding and automatically preventing injection attacks on Node.js - Tech + Hckr News 
 
 
- 
 
 Pingback: New top story on Hacker News: Synode: understanding and automatically preventing injection attacks on Node.js - ÇlusterAssets Inc., 
