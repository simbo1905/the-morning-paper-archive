---
blog_url: https://blog.acolyer.org/2016/12/08/just-say-no-to-paxos-overhead-replacing-consensus-with-network-ordering/
blog_title: Just say NO to Paxos overhead: replacing consensus with network&nbsp;ordering
---
...
> 
 ...
 By relying on the OUM primitive, NOPaxos avoids all coordination except in rare cases, eliminating nearly all the performance overhead of traditional replication protocols. It provides _throughput within 2% and latency within 16&micro;s of an unreplicated system, demonstrating that there need not be a tradeoff between enforcing strong consistency and providing maximum performance.
...
> 
 ...
 In 88% of cases, network serialization added no additional latency for the message to be received by a quorum of 3 receivers; the 99th percentile was less than 5&micro;s of added latency.
...
## Post navigation
 ...
 &lsaquo; PreviousInterlude: On assumptionsNext &rsaquo;DQBarge: Improving data-quality tradeoffs in large-scale internet services
...
## 
 19 thoughts on &ldquo;Just say NO to Paxos overhead: replacing consensus with network ordering&rdquo; 
...
- 
 ...
 Pingback: Say NO to custom hardware for Paxos  | slash dev slash null 
