---
blog_url: https://blog.acolyer.org/2016/12/06/the-snow-theorem-and-latency-optimal-read-only-transactions/
blog_title: The SNOW theorem and latency-optimal read-only&nbsp;transactions
---
...
## Post navigation
 ...
 &lsaquo; PreviousREX: A development platform and online learning approach for runtime emergent software systemsNext &rsaquo;Interlude: On assumptions
...
## 
 3 thoughts on &ldquo;The SNOW theorem and latency-optimal read-only transactions&rdquo; 
...
This paper is by my TA(Haonan Lu), my professor(Wyatt Lloyd) and others. Small world :D
...
Typo? You omiited S+N+W in your 'SNOW is tight' summary?
