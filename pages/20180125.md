---
blog_url: https://blog.acolyer.org/2018/01/25/a-static-verification-framework-for-message-passing-in-go-using-behavioural-types/
blog_title: A static verification framework for message passing in Go using behavioural&nbsp;types
---
...
## Post navigation
 ...
 &lsaquo; PreviousLinear Haskell: Practical linearity in a higher-order polymorphic languageNext &rsaquo;A practitioner’s guide to reading programming languages papers
...
## 
 One thought on &ldquo;A static verification framework for message passing in Go using behavioural types&rdquo; 
...
I wish to ask what was your aim of writing this particular blog. You have just picked the snippets from the paper and re written them here. Is that what you intended to do?
