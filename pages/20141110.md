---
blog_url: https://blog.acolyer.org/2014/11/10/monads-for-functional-programming/
blog_title: Monads for functional&nbsp;programming
---
...
## Post navigation
 ...
 &lsaquo; PreviousHighly Available Transactions: Virtues and LimitationsNext &rsaquo;The Power of Interoperability: why objects are inevitable
...
## 
 One thought on &ldquo;Monads for functional programming&rdquo; 
...
> In general, a function of type a -> b is replaced by a function of type a -> M b. This can be read as a function that accepts an argument of type a and returns a result of type b, with a possible side effect captured by M.

This is the ultimate description of the main idea behind the monads, I guess.
