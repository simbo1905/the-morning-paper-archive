---
blog_url: https://blog.acolyer.org/2018/11/16/overload-control-for-scaling-wechat-microservices/
blog_title: Overload control for scaling WeChat&nbsp;microservices
---
...
## Post navigation
 ...
 &lsaquo; PreviousUnikernels as processesNext &rsaquo;ScootR: scaling R dataframes on dataflow systems
...
## 
 9 thoughts on &ldquo;Overload control for scaling WeChat microservices&rdquo; 
...
- 
 ...
 Pingback: Overload control for scaling WeChat microservices - 近程端 
 
 
- 
 
 Pingback: SRE Weekly Issue #148 - SRE WEEKLY 
 
 
- 
 
 Pingback: 微信有多复杂？ - 欧博体育 
 
 
- 
 
 Pingback: 微信有多复杂？ - My Blog 
 
 
- 
 
 Pingback: 微信有多复杂？ - My World 
 
 
- 
 
 Pingback: 微信有多复杂？ - 美高梅官方开户 
 
 
- 
 
 Pingback: 微信有多复杂？ - Hatsune News 
...
In response to recent feedback from some readers, we (authors of the paper) have amended the algorithm of adaptive admission control to make its detailed strategies easier

to understand and corrected some minor errors found in the paper. Please access this link (https://arxiv.org/abs/1806.04075) to get the e-print update.
...
Hi, Lin. you have mentioned that “While Form1 is common in SOA, Form2 and Form3 are unique to the large-scale microservice architecture”in the article. I wonder why are Form2 and Form3 specific to microservices?What causes this? Can you give a simple case or scenario for Form2 and Form3?
