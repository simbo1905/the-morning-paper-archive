---
blog_url: https://blog.acolyer.org/2018/01/30/a-sample-of-brilliance/
blog_title: A sample of&nbsp;brilliance
---
...
## Post navigation
 ...
 &lsaquo; PreviousThe paradigms of programmingNext &rsaquo;A theory of the learnable
...
## 
 9 thoughts on &ldquo;A sample of brilliance&rdquo; 
...
- 
 ...
 Pingback: John Jason Fallows &raquo; Blog Archive New top story on Hacker News: A sample of brilliance - John Jason Fallows 
 
 
- 
 
 Pingback: New top story on Hacker News: A sample of brilliance - Tech + Hckr News 
 
 
- 
 
 Pingback: New top story on Hacker News: A sample of brilliance - NEWS TODAY 
 
 
- 
 
 Pingback: A sample of brilliance - posted at January 30, 2018 at 09:22AM by charlysl - Startup News 2018 
...
There's a bug in the first javascript implementation (sampleS code) on line 5.

s.add(randInt(1,n); should be s.add(randInt(1,n));
...
From the set of all permutations of 0..N-M-1, it is easy to pick one (random) permutation (wikipedia:Factoradic). Nothing more to say. :)
...
- 
 ...
 Pingback: New top story on Hacker News: A sample of brilliance - ÇlusterAssets Inc., 
...
I'm getting on a bit now; witness that I recall reading Programming Pearls when they first came out. This is my kind of paper. Thank you.
...
It looks like your JavaScript example for randInt would return a random integer from i to i + j - 1. It happens that every time you use randInt, i === 1, in which case it does return an integer from i to j. The way you present the function makes it seem like it would also work for i > 1, which is not the case.

I hope this helps anyone who was confused by that example.
