---
blog_url: https://blog.acolyer.org/2017/11/20/dejavu-a-map-of-code-duplicates-on-github/
blog_title: DéjàVu: a map of code duplicates on&nbsp;GitHub
---
...
## Post navigation
 ...
 &lsaquo; PreviousMastering the game of Go without human knowledgeNext &rsaquo;Algorand: scaling Byzantine agreements for cryptocurrencies
...
## 
 13 thoughts on &ldquo;DéjàVu: a map of code duplicates on GitHub&rdquo; 
...
- 
 ...
 Pingback: GitHub 上有大量重複的程式碼... | Gea-Suan Lin&#039;s BLOG 
 
 
- 
 
 Pingback: DéjàVu: a plot of code duplicates on GitHub | A1A 
...
- 
 ...
 Pingback: More than half of GitHub is duplicate code, researchers find - JeffPerales.com 
 
 
- 
 
 Pingback: Four short links: 22 November 2017 | | Crypto War - Bitcoin Guide 
 
 
- 
 
 Pingback: Анализ степени дублирования кода на GitHub 
 
 
- 
 
 Pingback: DéjàVu: a map of code duplicates on GitHub - Adrian Colyer's take | Kapua 
