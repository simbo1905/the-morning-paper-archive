---
blog_url: https://blog.acolyer.org/2018/05/09/photo-realistic-single-image-super-resolution-using-a-generative-adversarial-network/
blog_title: Photo-realistic single image super-resolution using a generative adversarial&nbsp;network
---
...
## Post navigation
 ...
 &lsaquo; PreviousImage-to-image translation with conditional adversarial networksNext &rsaquo;Progressive growing of GANs for improved quality, stability, and variation
...
## 
 4 thoughts on &ldquo;Photo-realistic single image super-resolution using a generative adversarial network&rdquo; 
...
- 
 ...
 Pingback: Photo-realistic single image super-resolution using a generative adversarial network | the morning paper - Datum 
 
 
- 
 
 Pingback: Four short links: 10 May 2018 - DUI Lawyer 
 
 
- 
 
 Pingback: Four short links: 10 May 2018 - Home Improvement Designs 
 
 
- 
 
 Pingback: Four short links: 10 May 2018 - O&#039;Reilly Media 
