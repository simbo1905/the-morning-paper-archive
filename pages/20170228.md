---
blog_url: https://blog.acolyer.org/2017/02/28/when-dnns-go-wrong-adversarial-examples-and-what-we-can-learn-from-them/
blog_title: When DNNs go wrong &#8211; adversarial examples and what we can learn from&nbsp;them
---
...
## Related
 ...
 Posted in Machine Learning, Security 
...
## Post navigation
 ...
 &lsaquo; PreviousUnderstanding, generalisation, and transfer learning in deep neural networksNext &rsaquo;Optimisation and training techniques for deep learning
...
## 
 13 thoughts on &ldquo;When DNNs go wrong - adversarial examples and what we can learn from them&rdquo; 
...
- 
 ...
 Chris Anderson (@chrisdotio) says: 

 
 April 1, 2017 at 1:02 am 
...
- 
 ...
 Pingback: Universal adversarial perturbations | the morning paper 
 
 
- 
 
 Pingback: Fooling Neural Networks - Curated SQL 
 
 
- 
 
 Pingback: Matrix capsules with EM routing | the morning paper 
...
- 
 ...
 Pingback: Comparing Human and Artificial Image Recognition: some considerations - Nonteek 
 
 
- 
 
 Pingback: Visione e riconoscimento umano vs Deep Vision: qualche considerazione. - Nonteek 
