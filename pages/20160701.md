---
blog_url: https://blog.acolyer.org/2016/07/01/building-end-to-end-dialogue-systems-using-generative-hierarchical-neural-network-models/
blog_title: Building end-to-end dialogue systems using generative hierarchical neural network&nbsp;models
---
...
We construct an artificial dialogue dataset by taking each {Q,A} pair as a two-turn dialog D = {U1 = Q, U2 = A} and use this to pretrain the model.

Bootstrapping gives significant gains in both perplexity and error-rate measures. The biggest gain is from SubTle, “we believe that this is because it trains all model parameters, unlike bootstrapping from Word2Vec, which only trains the work embeddings.”
...
## Post navigation
 ...
 &lsaquo; PreviousIncorporating (a) copying mechanism in sequence to sequence learningNext &rsaquo;Natural language understanding (almost) from scratch
...
## 
 2 thoughts on &ldquo;Building end-to-end dialogue systems using generative hierarchical neural network models&rdquo; 
...
- 
 ...
 Pingback: Mengenal Rinna, Sahabat Baru Buatan Microsoft - Blog - Virto Office | Sewa Kantor Surabaya 
