---
blog_url: https://blog.acolyer.org/2019/01/11/unsupervised-learning-of-artistic-styles-with-archetypal-style-analysis/
blog_title: Unsupervised learning of artistic styles with archetypal style&nbsp;analysis
---
...
- Compute the first and second-order statistics of each feature map. Given a layer with feature map , channels, and pixel positions we have:

- Normalise the statistics by the number of parameters at each layer (divide the statistics for layer l by ). This was found empirically to be useful for preventing over-representation of layers with more parameters.
...
## Post navigation
 ...
 &lsaquo; PreviousNeural Ordinary Differential EquationsNext &rsaquo;Serverless computing: one step forward, two steps back
...
## 
 2 thoughts on &ldquo;Unsupervised learning of artistic styles with archetypal style analysis&rdquo; 
...
- 
 ...
 Pingback: Four short links: 14 January 2019 - MasMaz 
 
 
- 
 
 Pingback: Four short links: 14 January 2019 - sportsguru 
