---
blog_url: https://blog.acolyer.org/2017/12/04/ffwd-delegation-is-much-faster-than-you-think/
blog_title: ffwd: delegation is (much) faster than you&nbsp;think
---
...
- FFWD_Server_Init() starts a server thread, and allocates and initialises the request and response lines

- FFWD_Delegate(s, f, retvar, argc, args...) delegates function f to server s, with specified arguments, storing the return value in retvar.
...
## Post navigation
 ...
 &lsaquo; PreviousAnalyzing software requirements errors in safety-critical embedded systemsNext &rsaquo;Hindsight: understanding the evolution of UI vulnerabilities in mobile browsers
...
## 
 12 thoughts on &ldquo;ffwd: delegation is (much) faster than you think&rdquo; 
...
- 
 ...
 Pingback: New top story on Hacker News: Ffwd: delegation is (much) faster than you think - ÇlusterAssets Inc., 
