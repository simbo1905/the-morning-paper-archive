---
blog_url: https://blog.acolyer.org/2019/04/12/master-of-web-puppets-abusing-web-browsers-for-persistent-and-stealthy-computation/
blog_title: Master of web puppets: abusing web browsers for persistent and stealthy&nbsp;computation
---
...
> 
Essentially, our work demonstrates that the trust model of web, which considers web publishers as trusted and allows them to execute code on the client-side without any restrictions is ﬂawed and needs reconsideration. Furthermore, this work aims to increase the awareness regarding the powerful capabilities that modern browser APIs provide to attackers, and to initiate a serious discussion about implementing restrictions while offering such capabilities that can be easily abused.
...
## Post navigation
 ...
 &lsaquo; PreviousDon’t trust the locals: investigating the prevalence of persistent client-side cross-site scripting in the wildNext &rsaquo;Time protection: the missing OS abstraction
...
## 
 9 thoughts on &ldquo;Master of web puppets: abusing web browsers for persistent and stealthy computation&rdquo; 
...
- 
 ...
 Pingback: New top story on Hacker News: Master of web puppets: abusing web browsers for persistent and stealthy - Outside The Know 
 
 
- 
 
 Pingback: New top story on Hacker News: Master of web puppets: abusing web browsers for persistent and stealthy - Hckr News 
 
 
- 
 
 Pingback: New top story on Hacker News: Master of web puppets: abusing web browsers for persistent and stealthy - World Best News 
 
 
- 
 
 Pingback: New top story on Hacker News: Master of web puppets: abusing web browsers for persistent and stealthy - News about world 
 
 
- 
 
 Pingback: New top story on Hacker News: Master of web puppets: abusing web browsers for persistent and stealthy - Golden News 
 
 
- 
 
 Pingback: New top story on Hacker News: Master of web puppets: abusing web browsers for persistent and stealthy - Latest news 
 
 
- 
 
 Pingback: Master of web puppets: abusing web browsers for persistent and stealthy | My Tech Blog 
...
Service Workers don't seem to be limited to one minute if the site can trick you into allowing notifications, which many do. I don't think that's the answer.
...
Success: More than 200 MB so of 60% shrunked my Service Worker folder! :D
