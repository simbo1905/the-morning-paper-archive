---
blog_url: https://blog.acolyer.org/2018/02/07/blockstack-a-global-naming-and-storage-system-secured-by-blockchain/
blog_title: Blockstack: a global naming and storage system secured by&nbsp;blockchain
---
...
The construction of the consensus hash allows a user to verify the authenticity of any virtualchain operation from a block with height , less that the current height h, using only a logarithmic number of queries.
...
## Post navigation
 ...
 &lsaquo; PreviousQuantum algorithms: an overviewNext &rsaquo;Chainspace: a sharded smart contracts platform
...
## 
 3 thoughts on &ldquo;Blockstack: a global naming and storage system secured by blockchain&rdquo; 
...
- 
 ...
 Pingback: Blockstack: a global naming and storage system secured by blockchain | Blockchain Wiki 
