---
blog_url: https://blog.acolyer.org/2019/05/31/lease-os/
blog_title: A case for lease-based, utilitarian resource management on mobile&nbsp;devices
---
...
## Post navigation
 ...
 &lsaquo; PreviousBoosted race trees for low energy classificationNext &rsaquo;Continuous integration of machine learning models with ease.ml/ci
...
## 
 4 thoughts on &ldquo;A case for lease-based, utilitarian resource management on mobile devices&rdquo; 
...
- 
 ...
 Pingback: A case for lease-based, utilitarian resource management on mobile devices | My Tech Blog 
 
 
- 
 
 Pingback: Un caso para la gestión de recursos utilitarios basados ​​en arrendamiento en dispositivos móviles - Demoaa 
 
 
- 
 
 Pingback: A case for lease-based, utilitarian resource management on mobile devices - Techie.Buzz 
...
Clorida's Lease management system enables you to take control of your business, inventory, renewal and maintenance cycles. User friendly, and comprehensive.
