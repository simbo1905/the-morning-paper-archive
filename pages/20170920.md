---
blog_url: https://blog.acolyer.org/2017/09/20/a-longitudinal-end-to-end-view-of-the-dnssec-ecosystem/
blog_title: A longitudinal, end-to-end view of the DNSSEC&nbsp;ecosystem
---
...
## Post navigation
 ...
 &lsaquo; PreviousTo type or not to type: quantifying detectable bugs in JavaScriptNext &rsaquo;CLKSCREW: Exposing the perils of security-oblivious energy management
...
## 
 5 thoughts on &ldquo;A longitudinal, end-to-end view of the DNSSEC ecosystem&rdquo; 
...
How much of this is due to DNS hosting providers that charge extra for DNSSEC signing? GoDaddy, for instance, puts DNSSEC functionality into it's "Premium DNS" upsell.
...
Yes, it is absolutely related with hosting provider's policy. You will be able to find the answer from our another paper "Understanding the Role of Registrars in DNSSEC Deployment", which will be published IMC'17 (http://conferences.sigcomm.org/imc/2017/program/)

The short answer for your question is that charing an extra money for DNSSEC doesn't help for DNSSEC deployment at all. For GoDaddy, we found that only 0.02% of (.com, .org, .net) domains are signed, but for OVH that provides DNSSEC for free, 25.9% of domains are signed.
...
- 
 ...
 September 30, 2017 at 12:50 pm 

 

 
 
If you use Godaddy's DNS servers you have to pay for DNSSEC. If you change the DNS servers of a domain registered at Godaddy to e.g. Cloudflare's free DNS servers you can configure DNSSEC without paying.
...
Our paper that focuses on the registrar has just been published in IMC'17, and you can see the paper here: https://conferences.sigcomm.org/imc/2017/papers/imc17-final53.pdf
...
- 
 ...
 Pingback: TrustBase: an architecture to repair and strengthen certificate-based authentication | the morning paper 
