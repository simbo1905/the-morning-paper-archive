---
blog_url: https://blog.acolyer.org/2019/09/11/procella/
blog_title: Procella: unifying serving and analytical data at&nbsp;YouTube
---
...
- For sorted columns, Artus’ encodings allow fast lookups in time, with seeks to a given row number.
