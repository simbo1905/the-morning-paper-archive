---
blog_url: https://blog.acolyer.org/2017/03/20/convolutional-neural-networks-part-1/
blog_title: Convolutional neural networks, Part&nbsp;1
---
...
- Using local response normalisation, which "implements a form of lateral inhibition inspired by the type found in real neurons, creating competition for big activities amongst neuron outputs computed using different kernels".

- Using overlapping pooling. Let pooling layers be of size z x z, and spaced s pixels apart. Traditionally pooling was used with s = z, so that there was no overlap between pools. Krizhevsky et al. used s = 2 and z = 3 to give overlapping pooling. This reduced the top-1 and top-5 error rates by 0.4% and 0.3% respectively.
...
## Post navigation
 ...
 &lsaquo; PreviousOmid reloaded: scalable and highly-available transaction processingNext &rsaquo;Convolution neural nets, Part 2
...
## 
 5 thoughts on &ldquo;Convolutional neural networks, Part 1&rdquo; 
...
- 
 ...
 Pingback: Convolution neural nets, Part 2 | the morning paper 
...
- 
 ...
 Pingback: Weekly ML drop #5 | Michał Łusiak 
