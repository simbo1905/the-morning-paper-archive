---
blog_url: https://blog.acolyer.org/2017/11/23/kv-direct-high-performance-in-memory-key-value-store-with-programmable-nic/
blog_title: KV-Direct: High-performance in-memory key-value store with programmable&nbsp;NIC
---
...
Without network batching, the tail latency ranges from 3-9 s depending on KV size, operation type, and key distribution. Network batching adds less than 1s latency, but significantly improves performance.
...
## Related
 ...
 Distributed SystemsHardwareNetworking 
...
## Post navigation
 ...
 &lsaquo; PreviousCanopy: an end-to-end performance tracing and analysis systemNext &rsaquo;On the information bottleneck theory of deep learning
...
## 
 14 thoughts on &ldquo;KV-Direct: High-performance in-memory key-value store with programmable NIC&rdquo; 
