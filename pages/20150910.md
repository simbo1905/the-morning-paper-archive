---
blog_url: https://blog.acolyer.org/2015/09/10/out-of-the-fire-swamp-part-iii-go-with-the-flow/
blog_title: Out of the Fire Swamp &#8211; Part III, Go with the&nbsp;flow.
---
...
## Post navigation
 ...
 &lsaquo; PreviousOut of the Fire Swamp - Part II, Peering into the mistNext &rsaquo;Jupiter Rising: A Decade of Clos Topologies and Centralized Control in Google's Datacenter Network
...
## 
 5 thoughts on &ldquo;Out of the Fire Swamp - Part III, Go with the flow.&rdquo; 
...
Adrian, you've managed to combine microservices, distributed systems, queues, stream processing, functional programming, cloud into one article!

The only way to scale microservices in an organization is to have queues between them which would mean usage of append-only data pipeline. And it follows that we get into stream processing and hence functional programming.

I agree with the sentiment because of the uptake of Kafka & Apache Spark, and in my own job, microservices + AWS SQS + AWS DynamoDB.
...
- 
 ...
 Pingback: L’architecture microservices sans la hype : qu’est-ce que c’est, à quoi ça sert, est-ce qu’il m’en faut ? | OCTO talks ! 
 
 
- 
 
 Pingback: Microservices architecture without the hype: what it is, what's the point, do I need one? | OCTO talks ! 
