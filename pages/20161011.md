---
blog_url: https://blog.acolyer.org/2016/10/11/progressive-neural-networks/
blog_title: Progressive neural networks
---
...
## Post navigation
 ...
 &lsaquo; PreviousAsynchronous methods for deep reinforcement learningNext &rsaquo;Towards deep symbolic reinforcement learning
...
## 
 5 thoughts on &ldquo;Progressive neural networks&rdquo; 
...
- 
 ...
 Pingback: Machine Learning Roundup 10/12/2016 | Big Analytics 
...
The concept that prior columns need to be frozen to "prevent catastropic forgetting" is so, how do I put it, single threaded.

This description reminds me of computing-in-the-old-days before multi-processors were common.

Passing "knowledge state" backwards and forwards learning sounds like a stack based model, where a single stack allows communications between processes.

The future of neural network thinking/modelling should (must?) take the learnings from thread-synchronisation and inter-process communication methods into account and figure out how light-weight they can get when dealing with these knowledge models.
...
- 
 ...
 October 29, 2017 at 12:27 am 

 

 
 
I noticed that you made a correlation between the number of columns of data and acceleration of convergence of the neural network. I was reminded of that idea that humans have very small short term memories, we can store only about 4-6 unrelated ideas in our head at the same time, but very large long term memories (which seem to have almost unlimited storage capacity). I was wondering if this was by an unfortunate accident of nature, or whether this might actually have a part to play in our learning system. Do you think a system that was really, really deep, splitting training data into a similar setup of about 4-6 data samples per column, would significantly outperform a system in terms of learning convergence verses one that was very tall (having 4-6 columns using all the data)?
...
- 
 ...
 Pingback: 5 Hot AI & Machine Learning Trends 2018 | SpringPeople Blog 
