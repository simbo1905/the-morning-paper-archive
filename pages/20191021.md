---
blog_url: https://blog.acolyer.org/2019/10/21/a-grammar-of-interactive-graphics/
blog_title: Vega-Lite: a grammar of interactive&nbsp;graphics
---
...
## Post navigation
 ...
 &lsaquo; PreviousHackPPL: a universal probabilistic programming languageNext &rsaquo;Futzing and moseying: interviews with professional data analysts on exploration practices
...
## 
 2 thoughts on &ldquo;Vega-Lite: a grammar of interactive graphics&rdquo; 
...
Hey, love the papers, but would be nice if they were more mobile friendly! I tend to read them on the way to work and it's a bit cumbersome ATM.

Currently running on Firefox on Android 10 on Pixel XL, generally an easy combo to support. About 20% of the horizontal space is taken by padding, and the images are unviewable. They're small with no way to expand except by zooming the whole site, and they're too low rez to see anything that way.
