---
blog_url: https://blog.acolyer.org/2016/10/06/simple-testing-can-prevent-most-critical-failures/
blog_title: Simple testing can prevent most critical&nbsp;failures
---
...
## Post navigation
 ...
 &lsaquo; PreviousWhy does deep and cheap learning work so well?Next &rsaquo;Incremental knowledge base construction using DeepDive
...
## 
 19 thoughts on &ldquo;Simple testing can prevent most critical failures&rdquo; 
...
- 
 ...
 Pingback: Failures In Distributed Databases | slash dev slash null 
 
 
- 
 
 Pingback: SRE Weekly Issue #43 - SRE WEEKLY 
...
- 
 ...
 Pingback: Week 37 | import digest 
...
- 
 ...
 Pingback: Error handling of in-vehicle networks makes them vulnerable | the morning paper 
 
 
- 
 
 Pingback: QA Дайджест #23: Релиз Selenium 3, полезный плагин к Jmeter и баги в Toyota : IT лента новостей &#8902; iAMX - Развлекательно-информационный портал 
...
- 
 ...
 Pingback: DevOps Newsletter 285 - Server Density Blog 
 
 
- 
 
 Pingback: DevOpsLinks #37 Thou Shalt Not Run A Database Inside A Container, Serverless Computing Tools &#038; Managing Environments with Ansible 🚀 - DevOpsLinks 
...
- 
 ...
 Pingback: Making smart contracts smarter | the morning paper 
 
 
- 
 
 Pingback: Testing Smarter with Mike Bland (Full Interview) | Hexawise.tv 
 
 
- 
 
 Pingback: Интересное-10 | Заметки о программной инженерии 
 
 
- 
 
 Pingback: 1 – Unit testing do&#039;s and don&#039;ts: Unit testing, you&#039;re doing it wrong | Traffic.Ventures Social 
 
 
- 
 
 Pingback: Unit testing, you're doing it wrong - Many Cores 
 
 
- 
 
 Pingback: What bugs cause cloud production incidents? - the morning paper 
