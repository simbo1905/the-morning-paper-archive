---
blog_url: https://blog.acolyer.org/2017/03/15/application-crash-consistency-and-performance-with-ccfs/
blog_title: Application crash consistency and performance with&nbsp;CCFS
---
...
> 
 ...
 Achieving correctness atop ccfs (while maintaining performance) required negligible developer overhead: we added one setstream() call to the beginning of each application, without examining the applications any further.
...
## Post navigation
 ...
 &lsaquo; PreviousPanoply: Low-TCB Linux applications with SGX enclavesNext &rsaquo;Deconstructing Xen
...
## 
 3 thoughts on &ldquo;Application crash consistency and performance with CCFS&rdquo; 
...
- 
 ...
 Pingback: 在 ext4 上的 CCFS | Gea-Suan Lin&#039;s BLOG 
