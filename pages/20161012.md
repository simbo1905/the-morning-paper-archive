---
blog_url: https://blog.acolyer.org/2016/10/12/towards-deep-symbolic-reinforcement-learning/
blog_title: Towards deep symbolic reinforcement&nbsp;learning
---
...
## Post navigation
 ...
 &lsaquo; PreviousProgressive neural networksNext &rsaquo;Go to statement considered harmful
...
## 
 17 thoughts on &ldquo;Towards deep symbolic reinforcement learning&rdquo; 
...
This is one of those 'send thrills down your spine' papers. Thanks!
...
- 
 ...
 Pingback: Machine Learning Roundup 10/13/2016 | Big Analytics 
...
Its a shame the paper does not mention or reference existing work in this area.
...
I think the approach you've outlined is definitely the way to go.
...
- 
 ...
 Pingback: Bookmarks for October 14th through October 15th : Extenuating Circumstances 
...
This seems kind of similar to Spaun [0]. You use Deep Learning to get the features you want and then you do symbolic like operations on those feature vectors to accomplish reinforcement learning. At least Spaun used neurons for the rule manipulation too. I also don't believe the transfer learning claim at all, because the tasks are way too similar. Still, it's a step in the right direction as far as I'm concerned [1]. That being said, good luck find a set of general prior rules and scaling them.

[0] http://science.sciencemag.org/content/338/6111/1202

[1] https://medium.com/@seanaubin/why-does-ai-still-suck-and-can-it-suck-less-9db36be294dc#.akb82s8o9
...
- 
 ...
 Pingback: Misc stuff: The verification gap, ML training and more - The Foretellix Blog 
...
Did you have a look at COQ program which is aimed

to prove through computation Mathematical Theorem ?

it seems sharing a lot of common points.
...
- 
 ...
 Pingback: Artificial Intelligence and life in 2030 | the morning paper 
...
Glad you enjoyed the paper, it's one of my recent favourites too. I've set the architecture diagram as the featured image in WordPress - hopefully that will do the trick....
...
This is so exciting. We're finally starting to make AI approaches that combine logical thinking with association-based learning-much like how the human brain works!

For the interested, here's a 3-minute excerpt from "Blink" (2007). Connecting the paper to this book was what made me so excited.

--

"Imagine that I were to ask you to play a very simple gambling game. In front of you are four decks of cards—two of them red and the other two blue. Each card in those four decks either wins you a sum of money or costs you some money. ...
...
For the interested, here's a 3-minute excerpt from Blink (2007). The obvious parallel is most of why I got so excited about this article.
...
- 
 ...
 Pingback: Interaction networks for learning about objects, relations and physics | the morning paper 
