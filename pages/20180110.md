---
blog_url: https://blog.acolyer.org/2018/01/10/mastering-chess-and-shogi-by-self-play-with-a-general-reinforcement-learning-algorithm/
blog_title: Mastering chess and shogi by self-play with a general reinforcement learning&nbsp;algorithm
---
...
## Post navigation
 ...
 &lsaquo; PreviousThe case for learned index structures - Part IINext &rsaquo;Emergent complexity via multi-agent competition
...
## 
 3 thoughts on &ldquo;Mastering chess and shogi by self-play with a general reinforcement learning algorithm&rdquo; 
...
Hi Adrian! This a really nice summary of the AlphaZero paper! I am trying to implement the paper and I am stuck at encoding policy. Out of the 73 planes, I am not clear with what do the last 9 planes stand for. Here is my understanding of underpromotions. A pawn can be promoted to Queen, Bishop, Rook, and Knight upon reaching the eighth rank. There can be three possible directions to make the move from the seventh to eighth rank: straight and two diagonals. That makes a total of 4 x 3 = 12 possible ways for underpromotion. I would appreciate if you could explain to me how it should be 9 planes instead of 12 planes. Where am I going wrong?
...
Hi Adrian! This is a really nice summary of AlphaZero paper, I appreciate it! Although I am a bit confused over this statement: "The final 9 planes encode possible underpromotions for pawn moves or captures in two possible diagonals, to knight, bishop, or rook respectively. Other pawn moves or captures from the seventh rank are promoted to a queen."

Could you please elaborate on how is it coming out to be 9 planes for underpromotion?
