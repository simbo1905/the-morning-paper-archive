---
blog_url: https://blog.acolyer.org/2016/02/16/capability-myths-demolished/
blog_title: Capability Myths Demolished
---
...
- ACL systems aggregate the permission to edit the permissions themselves by resource. In capability systems the ability to edit authorities is aggregated by subject. Property C: Subject Aggregated Authority Management. 
...
## Post navigation
 ...
 &lsaquo; PreviousA Short Note on Atomicity and OrderingNext &rsaquo;Deny Capabilities for Safe, Fast Actors
...
## 
 4 thoughts on &ldquo;Capability Myths Demolished&rdquo; 
...
Reblogged this on reperiendi and commented:
...
- 
 ...
 Pingback: Deny Capabilities for Safe, Fast Actors | the morning paper 
...
Interestingly, it appears that this paper was originally rejected for publication. The feedback given by the reviewers is actually available online, which is fairly rare. Worth having a read through them as it demonstrates how a lot of "peer review" feedback actually works. http://www.eros-os.org/pipermail/cap-talk/2003-March/001133.html
...
- 
 ...
 Pingback: [2016] Capability Myths Demolished-MPCM.org 
