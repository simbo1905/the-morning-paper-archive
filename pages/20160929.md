---
blog_url: https://blog.acolyer.org/2016/09/29/lets-talk-about-storage-and-recovery-methods-for-non-volatile-memory-database-systems/
blog_title: Let&#8217;s talk about storage and recovery methods for non-volatile memory database&nbsp;systems
---
...
## Post navigation
 ...
 &lsaquo; PreviousDistributed consensus and the implications of NVM on database management systemsNext &rsaquo;Write-limited sorts and joins for persistent memory
...
## 
 6 thoughts on &ldquo;Let's talk about storage and recovery methods for non-volatile memory database systems&rdquo; 
...
Thanks, a great article. Most of the links in the text are broken, they point to this page itself.
...
- 
 ...
 Pingback: Write-limited sorts and joins for persistent memory | the morning paper 
