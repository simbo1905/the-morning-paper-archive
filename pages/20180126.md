---
blog_url: https://blog.acolyer.org/2018/01/26/a-practitioners-guide-to-reading-programming-languages-papers/
blog_title: A practitioner’s guide to reading programming languages&nbsp;papers
---
...
Wherever the symbol t appears we can substitute any term. When a paper is referring to terms, the letter is often used, many times with subscripts to differentiate between different terms (e.g., , ). The set of all terms is often denoted by . This is not to be confused with , traditionally used to represent types.
...
## Post navigation
 ...
 &lsaquo; PreviousA static verification framework for message passing in Go using behavioural typesNext &rsaquo;The paradigms of programming
...
## 
 26 thoughts on &ldquo;A practitioner’s guide to reading programming languages papers&rdquo; 
...
- 
 ...
 Michael Schwarz (@93mSchwarz) says: 
...
- 
 ...
 Pingback: New top story on Hacker News: A practitioner’s guide to reading programming languages papers - NEWS TODAY 
 
 
- 
 
 Pingback: John Jason Fallows &raquo; Blog Archive New top story on Hacker News: A practitioner’s guide to reading programming languages papers - John Jason Fallows 
 
 
- 
 
 Pingback: New top story on Hacker News: A practitioner’s guide to reading programming languages papers - Tech + Hckr News 
...
- 
 ...
 AnhydroGlucopyr-Unit (@agumonkey) says: 
...
- 
 ...
 Pingback: Guide: Programming Language Papers | Math Online Tom Circle 
...
- 
 ...
 Pingback: Newsy programistyczne 2018-01-28 - DevNation 
 
 
- 
 
 Pingback: Sci/Math/Prog Summary: January 2018 - Abacus Noir Form 
...
- 
 ...
 Pingback: Hacker Bits, Issue 26 - Hacker Bits 
 
 
- 
 
 Pingback: B급 프로그래머 4월 1주 소식(개발/관리도구, 고성능 서버/ 데이터베이스 부문) | simple note 
...
- 
 ...
 February 9, 2020 at 9:36 am 

 

 
 
For semantics, I highly recommend chapter 2 of Tom Stuart's book "Understanding Computation", it provides a very lucid & gentle introduction for programmers into 3 kinds of formal semantics, also discussing how they relate to less formalized language specs / reference implementations.

That chapter is available for free as a sample under https://computationbook.com/.

The book is generally fun, preferring interactive sessions with 100% working code over math notation, but that chapter was the most novel for me (having a degree).
