---
blog_url: https://blog.acolyer.org/2019/03/06/keeping-calm-when-distributed-consistency-is-easy/
blog_title: Keeping CALM: when distributed consistency is&nbsp;easy
---
...
As the machines in the setup above exchange information about the edges they are aware of, then at some point the cycle involving and will come to light. No matter what other edges are later discovered, we know we have a deadlock. Deadlock detection in this system is monotonic.
...
In the first instance, we were asking a "Does there exist?" ( ) question. The presence of one positive example gives us an answer in the affirmative and additional positive examples don’t change that fact. In the second instance, we were asking a "Does not exist?" ( ) question. We can only answer a question like that once we’ve looked at every example. It’s the same for a "For all..." question ( ).
...
## Post navigation
 ...
 &lsaquo; PreviousEfficient large-scale fleet management via multi-agent deep reinforcement learningNext &rsaquo;A generalised solution to distributed consensus
...
## 
 20 thoughts on &ldquo;Keeping CALM: when distributed consistency is easy&rdquo; 
...
- 
 ...
 Pingback: New top story on Hacker News: Keeping CALM: when distributed consistency is easy - Golden News 
 
 
- 
 
 Pingback: New top story on Hacker News: Keeping CALM: when distributed consistency is easy - Outside The Know 
 
 
- 
 
 Pingback: New top story on Hacker News: Keeping CALM: when distributed consistency is easy - Hckr News 
 
 
- 
 
 Pingback: New top story on Hacker News: Keeping CALM: when distributed consistency is easy - World Best News 
 
 
- 
 
 Pingback: New top story on Hacker News: Keeping CALM: when distributed consistency is easy - Latest news 
 
 
- 
 
 Pingback: New top story on Hacker News: Keeping CALM: when distributed consistency is easy - News about world 
...
- 
 ...
 Pingback: Keeping CALM: when distributed consistency is easy | My Tech Blog 
 
 
- 
 
 Pingback: Keeping CALM: when distributed consistency is easy - Hacker News Robot 
 
 
- 
 
 Pingback: Keeping CALM: when distributed consistency is easy - TARIAN LIMITED 
...
- 
 ...
 Pingback: Tech roundup 13: a journal published by a bot - Javi López G. 
...
- 
 ...
 Pingback: A generalised solution to distributed consensus - GG&#039;s Place 
 
 
- 
 
 Pingback: Holonix: Verimlilik, Öngörülebilirlik ve Taşınabilirlik - Coinciyiz 
