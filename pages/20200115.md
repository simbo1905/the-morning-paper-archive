---
blog_url: https://blog.acolyer.org/2020/01/15/programmatically-interpretable-reinforcement-learning/
blog_title: Programmatically interpretable reinforcement&nbsp;learning
---
...
> 
Our solution to this problem is input augmentation, or periodic updates to set (the history). More precisely, after a certain number of search steps for a fixed set , and after choosing the best available synthesized program for this set, we sample a set of additional histories by simulating the current programmatic policy, and add these samples to .
...
## Post navigation
 ...
 &lsaquo; PreviousChallenges of real-world reinforcement learningNext &rsaquo;Synthesizing data structure transformations from input-output examples
...
## 
 15 thoughts on &ldquo;Programmatically interpretable reinforcement learning&rdquo; 
...
- 
 ...
 Pingback: New top story on Hacker News: Programmatically Interpretable Reinforcement Learning - Ultimate News 
 
 
- 
 
 Pingback: New top story on Hacker News: Programmatically Interpretable Reinforcement Learning - Outside The Know 
 
 
- 
 
 Pingback: Programmatically Interpretable Reinforcement Learning - INDIA NEWS 
 
 
- 
 
 Pingback: New top story on Hacker News: Programmatically Interpretable Reinforcement Learning - The Pakistani News Corner 
 
 
- 
 
 Pingback: New top story on Hacker News: Programmatically Interpretable Reinforcement Learning - Hckr News 
 
 
- 
 
 Pingback: New top story on Hacker News: Programmatically Interpretable Reinforcement Learning - protipsss 
...
- 
 ...
 Pingback: New top story on Hacker News: Programmatically Interpretable Reinforcement Learning - Latest news 
...
- 
 ...
 Pingback: New top story on Hacker News: Programmatically Interpretable Reinforcement Learning - News about world 
...
- 
 ...
 Pingback: Top story HACKER NEWS: Programmatically Interpretable Reinforcement Learning - Nate&#039;s Blog 
 
 
- 
 
 Pingback: Synthesizing data structure transformations from input-output examples - the morning paper 
 
 
- 
 
 Pingback: Tech roundup 58: a journal published by a bot - Javi López G. 
 
 
- 
 
 Pingback: Linkdump #126 | WZB Data Science Blog 
