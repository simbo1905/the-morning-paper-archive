---
blog_url: https://blog.acolyer.org/2019/09/27/wireless-attacks-on-aircraft-instrument-landing-systems/
blog_title: Wireless attacks on aircraft instrument landing&nbsp;systems
---
...
ILS is made up of three independent subsystems. The localizer provides guidance on whether the plane is to the right or the left of the ideal centreline approach to the runway. The glidescope provides guidance on whether the plane is above or below the ideal glide path onto the runway. The increasing obsolete (replaced by GPS) marker beacon subsystem provides checkpoints that help determine distance to the runway.
...
## Post navigation
 ...
 &lsaquo; Previous50 ways to leak your data: an exploration of apps’ circumvention of the Android permissions systemNext &rsaquo;Small world with high risks: a study of security threats in the npm ecosystem
...
## 
 19 thoughts on &ldquo;Wireless attacks on aircraft instrument landing systems&rdquo; 
...
Isn't the defense rather easy? You just put a fixed ILS receiver about 100m from the transmitters. Since this is on a fixed location, a change in the DDM is a broken transmitter or an attack. Just disable the ILS and the plane/pilots know how to handle an ILS failure.
...
I don’t remember where, but I have seen a design for unspoofable GPS. 

Just signing the signal is insufficient because of replay attacks. The system used a signal with a spreading sequence that was unknown to the receiver, making it necessary to make a short recording of the entire RF band. Only after a short delay sufficient for thwarting replay attacks the receiver gets the signed seed of the spreading sequence.

Very high gain directional antennas tracking the satellites might be used to mount a successful replay attack against this system by delaying and retransmitting the entire band. But the required effort is very hig. The gain required to achieve an SNR that will fool the receiver may not be feasible.
...
- 
 ...
 Pingback: New top story on Hacker News: Wireless attacks on aircraft instrument landing systems - protipsss 
 
 
- 
 
 Pingback: New top story on Hacker News: Wireless attacks on aircraft instrument landing systems - Latest news 
 
 
- 
 
 Pingback: New top story on Hacker News: Wireless attacks on aircraft instrument landing systems - Golden News 
 
 
- 
 
 Pingback: New top story on Hacker News: Wireless attacks on aircraft instrument landing systems - Outside The Know 
 
 
- 
 
 Pingback: New top story on Hacker News: Wireless attacks on aircraft instrument landing systems - World Best News 
 
 
- 
 
 Pingback: New top story on Hacker News: Wireless attacks on aircraft instrument landing systems - News about world 
 
 
- 
 
 Pingback: New top story on Hacker News: Wireless attacks on aircraft instrument landing systems - Hckr News 
 
 
- 
 
 Pingback: Wireless attacks on aircraft instrument landing systems - INDIA NEWS 
...
One simple metod will be monotoring land fixed receptors and in the presence of an atack alert the pilots!
...
- 
 ...
 Pingback: Wireless attacks on aircraft instrument landing systems - Lapcity 
...
Why do authentication and cryptography not aid in mitigation?
...
- 
 ...
 Pingback: Wireless attacks on aircraft instrument landing systems - Hacker News Robot 
...
Interesting point of view. Reminds me of the movie ‘Die Hard’ where the flight path/glide slope of the planes on approach was changed ending under the ground leading to a disaster...
...
- 
 ...
 Pingback: WeWork CEO steps down and more events at Itnig - itnig&#039;s blog 
 
 
- 
 
 Pingback: WeWork CEO steps down and more events at Itnig - Read our stories 
 
 
- 
 
 Pingback: Video Series with Quipu and Factorial & other Startups News - Itnig 
