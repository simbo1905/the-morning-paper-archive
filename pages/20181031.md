---
blog_url: https://blog.acolyer.org/2018/10/31/moment-based-quantile-sketches-for-efficient-high-cardinality-aggregation-queries/
blog_title: Moment-based quantile sketches for efficient high cardinality aggregation&nbsp;queries
---
...
## Post navigation
 ...
 &lsaquo; PreviousNoria: dynamic, partially-stateful data-flow for high-performance web applicationsNext &rsaquo;The FuzzyLog: a partially ordered shared log
...
## 
 One thought on &ldquo;Moment-based quantile sketches for efficient high cardinality aggregation queries&rdquo; 
...
- 
 ...
 Pingback: DDSketch: a fast and fully-mergeable quantile sketch with relative-error guarantees - the morning paper 
