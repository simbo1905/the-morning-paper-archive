---
blog_url: https://blog.acolyer.org/2017/03/31/bbr-congestion-based-congestion-control/
blog_title: BBR: Congestion-based congestion&nbsp;control
---
...
## Related
 ...
 Algorithms and data structuresGoogleNetworking 
...
## Post navigation
 ...
 &lsaquo; PreviousStochastic program optimizationNext &rsaquo;A study of security vulnerabilities on Docker Hub
...
## 
 8 thoughts on &ldquo;BBR: Congestion-based congestion control&rdquo; 
...
There is a related report of better TCP congestion control deployed with a banks data centre https://www.usenix.org/system/files/conference/nsdi15/nsdi15-paper-judd.pdf
...
- 
 ...
 Pingback: BBR: Congestion-based congestion control | Ace Infoway 
 
 
- 
 
 Pingback: BBR: Congestion-based congestion control https://blog.acolyer.org/2... | Dr. Roy Schestowitz (罗伊) 
 
 
- 
 
 Pingback: Links 3/4/2017: Linux 4.11 RC5, Mesa 17.0.3, GTK+ 3.90.0 | Techrights 
...
Please do an article on the rowhammer exploit
...
In your on_ack pseudocode, you've badly mangled the calculation of deliveryRate. To anyone reading this, refer to the correct code in the original article!
...
- 
 ...
 Pingback: The QUIC transport protocol: design and Internet-scale deployment | the morning paper 
