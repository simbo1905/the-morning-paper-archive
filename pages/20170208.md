---
blog_url: https://blog.acolyer.org/2017/02/08/does-the-online-card-payment-landscape-unwittingly-facilitate-fraud/
blog_title: Does the online card payment landscape unwittingly facilitate&nbsp;fraud?
---
...
## Post navigation
 ...
 &lsaquo; PreviousFinding security bugs in web applications using a catalog of access control patternsNext &rsaquo;Value iteration networks
...
## 
 4 thoughts on &ldquo;Does the online card payment landscape unwittingly facilitate fraud?&rdquo; 
...
I guess an additional layer that implement this standardization could help. Like people register their credit card numbers to a service like apple pay or Google pay(where a better standardization is implemented) and clients pay using these services would solve this problem?
...
- 
 ...
 Pingback: Worth Reading: How long does it take to steal a credit card number? - &#039;net work 
...
I think the author has provided adequate solutions for todays complex paymentscape. Cut and dry. And ive got two words for everyone else:

Block chain.

Instant global payments and multi sig tokenized wallets with zero to no fees . 
