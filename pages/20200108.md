---
blog_url: https://blog.acolyer.org/2020/01/08/ironies-of-automation/
blog_title: Ironies of automation
---
...
## Post navigation
 ...
 &lsaquo; PreviousThe Year AheadNext &rsaquo;Ten challenges for making automation a 'team player' in joint human-agent activity
...
## 
 12 thoughts on &ldquo;Ironies of automation&rdquo; 
...
I see this being very relevant in aviation, particularly in cases where pilots are relying on auto-pilot functionality of a aircraft and on a failure, have to discern the cause of the error and take appropriate corrective action (sometimes within seconds). It is simply not feasible to simulate all possible failure scenarios of a complex aircraft in a simulator.
...
- 
 ...
 Pingback: Stuff The Internet Says On Scalability For January 10th, 2020 - Amazon Web Services Feed 
 
 
- 
 
 Pingback: Ironies of Automation - cafebedouin.org 
 
 
- 
 
 Pingback: 架構週報：如何看待國產編程語言“木蘭”問世？ - KKNEWS 
 
 
- 
 
 Pingback: Not So Random Software - Week #10 - Alfredo Motta 
...
This reminds me about work from T. Inagaki, Adaptive Automation: Sharing and Trading of Control, 2003.

The dynamic adaptation of automation (machine or human) can rely on different approaches and decision criterii. There is also a section on "Automation Surprise" which is very relevant to the issues raised on the article write-up.
...
In IT, at least, those operators themselves are doing the automation, so by definition they already understand what they are automating. In such case the point of "investing into operator" is invalid.
...
- 
 ...
 Pingback: What the SIEM & SOAR industry could learn from a paper from 1983 
