---
blog_url: https://blog.acolyer.org/2015/01/22/the-design-philosophy-of-the-darpa-internet-protocols/
blog_title: The Design Philosophy of the DARPA Internet&nbsp;Protocols
---
...
- Eliminating the need for connection state in intermediate nodes

- Providing a building block on top of which a variety of services can be built

- Representing the minimum network server assumption, enabling a wide variety of networks to be easily incorporated. 
...
## Post navigation
 ...
 &lsaquo; PreviousA new presumed commit optimisation for two-phase commitNext &rsaquo;The MADlib Analytics Library
...
## 
 7 thoughts on &ldquo;The Design Philosophy of the DARPA Internet Protocols&rdquo; 
...
- 
 ...
 Pingback: Michael Tsai - Blog - The Design Philosophy of the DARPA Internet Protocols 
...
- 
 ...
 Pingback: 互操作性的区块链系统设计理念互操作性的区块链系统设计理念 | luckybutterfly 
...
- 
 ...
 Pingback: 互操作性的区块链系统设计理念 - 比特币日报 
 
 
- 
 
 Pingback: 干货 | 互操作性的区块链系统设计理念 - 比特币日报 
 
 
- 
 
 Pingback: 互操作性的区块链系统设计理念-BitChina.Net 
