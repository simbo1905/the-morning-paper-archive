---
blog_url: https://blog.acolyer.org/2018/07/03/privacy-risks-with-facebooks-pii-based-targeting-auditing-a-data-brokers-advertising-interface/
blog_title: Privacy risks with Facebook’s PII-based targeting: auditing a data broker’s advertising&nbsp;interface
---
...
How does that help us get a phone number?? A phone number is one of the types of PII we can match on. So we create subsets lists of all possible phone numbers, where in we have all phone numbers where the ith digit has value j. Now for each i, we should find exactly one j such that the victim is in .
...
## Post navigation
 ...
 &lsaquo; PreviousThe rise of the citizen developer: assessing the security impact of online app generatorsNext &rsaquo;Grand Pwning Unit: Accelerating microarchitectural attacks with the GPU
...
## 
 6 thoughts on &ldquo;Privacy risks with Facebook’s PII-based targeting: auditing a data broker’s advertising interface&rdquo; 
...
- 
 ...
 Pingback: New top story on Hacker News: Privacy risks with Facebook’s PII-based targeting: auditing a data broker - Latest news 
 
 
- 
 
 Pingback: New top story on Hacker News: Privacy risks with Facebook’s PII-based targeting: auditing a data broker - News about world 
 
 
- 
 
 Pingback: New top story on Hacker News: Privacy risks with Facebook’s PII-based targeting: auditing a data broker - World Best News 
 
 
- 
 
 Pingback: New top story on Hacker News: Privacy risks with Facebook’s PII-based targeting: auditing a data broker - Tech + Hckr News 
 
 
- 
 
 Pingback: New top story on Hacker News: Privacy risks with Facebook’s PII-based targeting: auditing a data broker - ÇlusterAssets Inc., 
