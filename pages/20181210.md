---
blog_url: https://blog.acolyer.org/2018/12/10/madmax-surviving-out-of-gas-conditions-in-ethereum-smart-contracts/
blog_title: MadMax: surviving out-of-gas conditions in Ethereum smart&nbsp;contracts
---
...
The following code will also run out of gas if 256 or more payees are added, due to integer overflow on the inferred type of var i as uint8. (In this instance at least, that’s arguably better than the infinite loop alternative).
...
## Post navigation
 ...
 &lsaquo; PreviousRapidChain: scaling blockchain via full shardingNext &rsaquo;GraphIt: A high-performance graph DSL
...
## 
 7 thoughts on &ldquo;MadMax: surviving out-of-gas conditions in Ethereum smart contracts&rdquo; 
...
You've got the typo in MadMax url. The correct is https://github.com/nevillegrech/MadMax
...
Thanks for posting this article! It really covers all the basics of ethereum smart contracts work. If you’re not so smart, you’re

https://softmedialab.com/blog/how-to-build-ethereum-smart-contract/

This will cover some techical basis.
...
The github link to MadMax is broken, or it's a private repo. Thanks for the post!
...
hey! Just a comment on "the contract will run out of gas". A contract never runs out of gas. Rather, the execution of one of its function will fail to terminate because the execution is consuming too much gas from the transaction (which triggered the execution) that does not contain enough.
...
Hi Adrian, thanks for the coverage!

The Github URL is actually https://github.com/nevillegrech/MadMax
