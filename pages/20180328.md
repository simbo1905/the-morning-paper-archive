---
blog_url: https://blog.acolyer.org/2018/03/28/deep-learning-scaling-is-predictable-empirically/
blog_title: Deep learning scaling is predictable,&nbsp;empirically
---
...
> 
 ...
 We expect the number of model parameters to fit a data set should follow where is the required model size to fin a training set of size , and .

Best-fit models grow sublinearly in training shard size. Higher values of indicate models that make less effective use of extra parameters on larger data sets. Despite model size scaling differences though, "for a given model architecture, we can accurately predict the model size that will best fit increasingly larger data sets."
...
## Post navigation
 ...
 &lsaquo; PreviousAnna: A KVS for any scaleNext &rsaquo;Adversarial patch
...
## 
 10 thoughts on &ldquo;Deep learning scaling is predictable, empirically&rdquo; 
...
- 
 ...
 March 28, 2018 at 6:29 am 

 

 
 
Today's article brought to mind https://www.lesswrong.com/posts/33YYcoWwtmqzAq9QR/beware-of-weird-psychological-samples and http://www.racismreview.com/blog/2010/12/24/weird-bias-in-western-social-science-research/

A considered meta-analysis of the learning data sets is required to ensure that the underlying assumptions are robust.
...
>> "On the other hand, more data puts us on an exponential path of improvement."

I don't follow this. The relation is a power law, and sublinear at that. How is the improvement exponential?
...
You're quite right. That sentence doesn't make any sense! For starters, the error will always be between 0 and 100%, and the power law shows that we get bigger bang for the buck adding more data when we have comparatively little than we do later on. It should say "puts us on a power law path of improvement." I will update the text accordingly. Thanks, A. 
...
- 
 ...
 Pingback: Deep Learning Scaling Is Predictable, Empirically - Nerd Junkie 
 
 
- 
 
 Pingback: Deep Learning Scaling Is Predictable, Empirically - TECHRELEASE 
 
 
- 
 
 Pingback: Deep learning scaling is predictable, empirically - The Quant Market 
 
 
- 
 
 Pingback: New Evidence Points to a Potentially Superior Deep Learning Project Management Strategy - Aidoc 
