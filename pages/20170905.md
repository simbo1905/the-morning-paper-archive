---
blog_url: https://blog.acolyer.org/2017/09/05/luck-is-hard-to-beat-the-difficulty-of-sports-prediction/
blog_title: Luck is hard to beat: the difficulty of sports&nbsp;prediction
---
...
- Let , , and be the probabilities that a home team wins, draws (ties) or loses respectively.

- The expected value of is therefore , and variance is . (And the similarly for the expected value of ).
...
## Post navigation
 ...
 &lsaquo; Previous"The Leicester City fairytale?": Utilizing new soccer analytics tools to compare performance in the 15/16 and 16/17 EPL seasonsNext &rsaquo;REM: Resource-efficient mining for blockchains
