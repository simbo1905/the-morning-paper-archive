---
blog_url: https://blog.acolyer.org/2017/09/19/to-type-or-not-to-type-quantifying-detectable-bugs-in-javascript/
blog_title: To type or not to type: quantifying detectable bugs in&nbsp;JavaScript
---
...
## Post navigation
 ...
 &lsaquo; PreviousBringing the web up to speed with WebAssemblyNext &rsaquo;A longitudinal, end-to-end view of the DNSSEC ecosystem
...
## 
 51 thoughts on &ldquo;To type or not to type: quantifying detectable bugs in JavaScript&rdquo; 
...
- 
 ...
 Pingback: Flow and TypeScript conservatively prevent about 15% of the bugs - Full-Stack Feed 
...
- 
 ...
 Cristian Klein (@cristianklein_) says: 
...
- 
 ...
 Patrick Desjardins (@mrdesjardins) says: 
...
- 
 ...
 Pingback: To type or not to type: quantifying detectable bugs in JavaScript | ExtendTree 
...
- 
 ...
 Pingback: Do Strongly Typed Languages Reduce Bugs? - R- Pakistan Daily Roznama 
...
- 
 ...
 Pingback: ‘Encouraging’ study examines static typing and quantifying detectable bugs in JavaScript - تکنولوژی ، اخبار تکنولوژی ، تکنولوژی روز 
...
- 
 ...
 Pingback: ‘Encouraging’ study examines static typing and quantifying detectable bugs in JavaScript | Geek Tech News 
...
- 
 ...
 Pingback: Fast and precise type checking for JavaScript | the morning paper 
...
- 
 ...
 Pingback: The 30 Most Popular JavaScript Development Blog Posts Of 2017 | Blog Brainhub.eu 
 
 
- 
 
 Pingback: Web Insights – Your JS/CSS/UI/UX Digest #12 - getButterfly 
 
 
- 
 
 Pingback: 3 Reasons Why We Use TypeScript to Boost Dev Productivity | Unbounded Systems 
 
 
- 
 
 Pingback: Programming: Links and Resources (10) | Angel "Java" Lopez on Blog 
 
 
- 
 
 Pingback: TypeScript VS JavaScript | adictosaltrabajo 
 
 
- 
 
 Pingback: Flow Type for coding in JavaScript with guardrails | 
...
- 
 ...
 Pingback: JSDoc + React: Qualitätssteigerung und Verbesserung der Experience 
 
 
- 
 
 Pingback: &lsquo;Encouraging&rsquo; study examines static typing and quantifying detectable bugs in JavaScript | Developer Tech News 
