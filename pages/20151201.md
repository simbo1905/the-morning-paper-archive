---
blog_url: https://blog.acolyer.org/2015/12/01/rop/
blog_title: The geometry of innocent flesh on the bone: Return-into-libc without function calls (on&nbsp;x86)
---
...
## Post navigation
 ...
 &lsaquo; PreviousSoK: Eternal War in MemoryNext &rsaquo;Experimental Security Analysis of a Modern Automobile
...
## 
 5 thoughts on &ldquo;The geometry of innocent flesh on the bone: Return-into-libc without function calls (on x86)&rdquo; 
...
- 
 ...
 Pingback: Detecting ROP with statistical learning of program characteristics | the morning paper 
 
 
- 
 
 Pingback: Hardware is the new software | the morning paper 
 
 
- 
 
 Pingback: The dynamics of innocent flesh on the bone: code reuse ten years later | the morning paper 
 
 
- 
 
 Pingback: Spectre attacks: exploiting speculative execution | the morning paper 
