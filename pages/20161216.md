---
blog_url: https://blog.acolyer.org/2016/12/16/tensorflow-a-system-for-large-scale-machine-learning/
blog_title: TensorFlow: A system for large-scale machine&nbsp;learning
---
...
The simplest queue is FIFOQueue, which owns an internal queue of tensors, and allows concurrent access in first-in first-out order. Other types of queues dequeue tensors in random and priority orders, which ensure that input data are sampled appropriately.
...
## Related
 ...
 Deep LearningGoogleMachine Learning 
...
## Post navigation
 ...
 &lsaquo; PreviousFaSST: Fast, scalable and simple distributed transactions with two-sided (RDMA) datagram RPCsNext &rsaquo;So that was 2016
...
## 
 3 thoughts on &ldquo;TensorFlow: A system for large-scale machine learning&rdquo; 
...
- 
 ...
 Pingback: TensorFlow: A system for large-scale machine learning - Artificial Intelligence 
...
- 
 ...
 Pingback: Dynamic control flow in large-scale machine learning | the morning paper 
