---
blog_url: https://blog.acolyer.org/2015/02/13/the-chubby-lock-service-for-loosely-coupled-distributed-systems/
blog_title: The Chubby lock service for loosely coupled distributed&nbsp;systems
---
...
## Related
 ...
 ConsistencyDistributed SystemsGoogle 
...
## Post navigation
 ...
 &lsaquo; PreviousEnterprise Database Applications and the Cloud: A difficult road aheadNext &rsaquo;Desert Island Papers: Peter Alvaro
...
## 
 4 thoughts on &ldquo;The Chubby lock service for loosely coupled distributed systems&rdquo; 
...
- 
 ...
 Pingback: SAMC: Semantic-aware model checking for fast discovery of deep bugs in cloud systems | the morning paper 
 
 
- 
 
 Pingback: Panopticon: An Omniscient Lock Broker for Efficient Distributed Transactions in the Datacenter | the morning paper 
